// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_coif1_2_Level_fixed\alpha1st_Level_Recon1.v
...
// Source Path: final_heart_coif1_2_Level_fixed/DWT_coif1_2_Level/1st_Level_Recon1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon1
  ...
  wire signed [15:0] LoR_Odd1_out1_1;  // sfix16_En24
  ...
  wire signed [15:0] LoR_Even1_out1_1;  // sfix16_En24
  ...
  assign LoR_Odd1_out1_1 = delayMatch1_reg[6];
  assign delayMatch1_reg_next[0] = LoR_Odd1_out1;
  ...
  assign LoR_Even1_out1_1 = delayMatch_reg[6];
  assign delayMatch_reg_next[0] = LoR_Even1_out1;
