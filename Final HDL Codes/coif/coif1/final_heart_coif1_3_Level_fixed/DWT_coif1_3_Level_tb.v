// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_coif1_3_Level_fixed\DWT_coif1_3_Level_tb.v
// Created: 2024-04-18 12:09:40
// 
...
module DWT_coif1_3_Level_tb;
  ...
  reg [12:0] Data_Type_Conversion_out1_addr;  // ufix13
  wire Data_Type_Conversion_out1_active;  // ufix1
  reg  tb_enb_delay;
  wire Data_Type_Conversion_out1_enb;  // ufix1
  wire [12:0] Data_Type_Conversion_out1_addr_delay_1;  // ufix13
  reg signed [31:0] fp_In1;  // sfix32
  reg [15:0] rawData_In1;  // ufix16_En24
  reg signed [31:0] status_In1;  // sfix32
  reg [15:0] holdData_In1;  // ufix16_En24
  reg [15:0] In1_offset;  // ufix16_En24
  wire [15:0] In1;  // ufix16_En24
  ...
  assign Out1_active = Out1_addr != 13'b1000100111010;



  assign Data_Type_Conversion_out1_active = Data_Type_Conversion_out1_addr != 13'b1000100111010;
  ...
  always @(posedge clk)
    begin : DataTypeConversion_process
      if (reset == 1'b1) begin
        Data_Type_Conversion_out1_addr <= 13'b0000000000000;
      end
      else begin
        if (Data_Type_Conversion_out1_enb) begin
          if (Data_Type_Conversion_out1_addr >= 13'b1000100111010) begin
            Data_Type_Conversion_out1_addr <= 13'b0000000000000;
          end
          else begin
            Data_Type_Conversion_out1_addr <= Data_Type_Conversion_out1_addr + 13'b0000000000001;
          end
        end
      end
    end
  ...
  DWT_coif1_3_Level u_DWT_coif1_3_Level (.clk(clk),
                                         .reset(reset),
  ...
  always @(posedge clk)
    begin : c_2_process
      if (reset == 1'b1) begin
        ...
        if (Out1_enb) begin
          if (Out1_addr >= 13'b1000100111010) begin
            Out1_addr <= 13'b0000000000000;
          end
          else begin
  ...
  assign Out1_lastAddr = Out1_addr >= 13'b1000100111010;
...
endmodule  // DWT_coif1_3_Level_tb
