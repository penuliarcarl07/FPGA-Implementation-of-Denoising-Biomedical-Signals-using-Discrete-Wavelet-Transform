// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_coif1_3_Level_fixed\alpha1st_Level_Recon1.v
...
// Source Path: final_heart_coif1_3_Level_fixed/DWT_coif1_3_Level/1st_Level_Recon1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon1
  ...
  wire signed [15:0] delayMatch_reg_next [0:56];  // sfix16_En29 [57]
  wire signed [15:0] HiR_Even1_out1_1;  // sfix16_En29
  wire signed [15:0] HiR_Odd1_out1;  // sfix16_En28
  reg signed [15:0] delayMatch1_reg [0:56];  // sfix16 [57]
  wire signed [15:0] delayMatch1_reg_next [0:56];  // sfix16_En28 [57]
  ...
  HiR_Even1_block u_HiR_Even1 (.clk(clk),
                               .reset(reset),
                               .enb(enb),
  ...
  assign HiR_Even1_out1_1 = delayMatch_reg[56];
  ...
  HiR_Odd1_block u_HiR_Odd1 (.clk(clk),
                             .reset(reset),
                             .enb(enb),
  ...
  assign HiR_Odd1_out1_1 = delayMatch1_reg[56];
  ...
  LoR_Odd1_block u_LoR_Odd1 (.clk(clk),
                             .reset(reset),
                             .enb(enb),
  ...
  LoR_Even1_block u_LoR_Even1 (.clk(clk),
                               .reset(reset),
                               .enb(enb),
                               .In_LoR_e(In_LoD),  // sfix16_En23
                               .Out_LoR_e(LoR_Even1_out1)  // sfix16_En24
                               );
  assign Add_add_cast = {{5{HiR_Even1_out1_1[15]}}, HiR_Even1_out1_1[15:5]};
