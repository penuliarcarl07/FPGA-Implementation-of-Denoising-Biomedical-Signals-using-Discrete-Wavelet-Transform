// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_coif1_3_Level_fixed\LoR_Odd1_block1.v
...
// -------------------------------------------------------------
// 
// Module: LoR_Odd1_block1
// Source Path: final_heart_coif1_3_Level_fixed/DWT_coif1_3_Level/1st_Level_Recon4/LoR_Odd1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoR_Odd1_block1
  ...
  output  signed [15:0] Out_HiR_o;  // sfix16_En24
  ...
  wire signed [15:0] LoR_5_out1;  // sfix16_En20
  reg signed [15:0] LoR_5_out1_1;  // sfix16_En20
  ...
  assign LoR_1_out1 = 16'b1010110100000001;
  ...
  assign LoR_3_out1 = 16'b1100010100001101;
  ...
  assign LoR_5_out1 = 16'sb1011111111100000;
  ...
  assign Add1_add_cast = {{4{Multiply2_out1_1[15]}}, Multiply2_out1_1[15:4]};
