// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db4_2_Level_fixdt\HiR_Odd_block.v
...
// Source Path: db4_2_Level_fixdt/DWT_db4_2_Level/2nd_Level_Recon/HiR_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiR_Odd_block
  ...
  wire signed [15:0] HiR_1_out1;  // sfix16_En19
  reg signed [15:0] HiR_1_out1_1;  // sfix16_En19
  reg signed [15:0] In_HiR_e_1;  // sfix16_En27
  wire signed [31:0] Multiply_mul_temp;  // sfix32_En46
  wire signed [15:0] Multiply_out1;  // sfix16_En32
  reg signed [15:0] Multiply_out1_1;  // sfix16_En32
  wire [15:0] HiR_3_out1;  // ufix16_En18
  reg [15:0] HiR_3_out1_1;  // ufix16_En18
  ...
  wire signed [15:0] HiR_7_out1;  // sfix16_En17
  reg signed [15:0] HiR_7_out1_1;  // sfix16_En17
  ...
  assign HiR_1_out1 = 16'sb1011110010101000;
  ...
  assign Multiply_mul_temp = HiR_1_out1_1 * In_HiR_e_1;
  ...
  assign HiR_3_out1 = 16'b1011111110000110;
  ...
  assign HiR_5_out1 = 16'sb1010111100111111;
  ...
  assign HiR_7_out1 = 16'sb1000101000001100;
