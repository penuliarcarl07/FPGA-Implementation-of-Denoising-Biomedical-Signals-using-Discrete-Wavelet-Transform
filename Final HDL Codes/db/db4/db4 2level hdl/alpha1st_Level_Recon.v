// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db4_2_Level_fixdt\alpha1st_Level_Recon.v
...
// Source Path: db4_2_Level_fixdt/DWT_db4_2_Level/1st_Level_Recon
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon
  ...
  assign kconst = 16'b1110111011001000;
  ...
  LoR_Even u_LoR_Even (.clk(clk),
                       .reset(reset),
                       .enb(enb),
                       .In_HiR_e(In_LoD),  // sfix16_En23
                       .Out_HiR_e(LoR_Even_out1)  // sfix16_En23
                       );
  always @(posedge clk)
  ...
  HiR_Odd u_HiR_Odd (.clk(clk),
                     ...
                     .enb(enb),
                     .In_HiR_e(In_HiD),  // sfix16_En27
                     .Out_HiR_e(HiR_Odd_out1)  // sfix16_En28
                     );
  LoR_Odd u_LoR_Odd (.clk(clk),
                     .reset(reset),
                     .enb(enb),
                     .In_HiR_e(In_LoD),  // sfix16_En23
                     .Out_HiR_e(LoR_Odd_out1)  // sfix16_En23
                     );
  always @(posedge clk)
