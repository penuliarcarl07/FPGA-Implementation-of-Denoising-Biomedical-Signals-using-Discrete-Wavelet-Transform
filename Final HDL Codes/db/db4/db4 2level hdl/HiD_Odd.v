// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db4_2_Level_fixdt\HiD_Odd.v
...
// 
// Module: HiD_Odd
// Source Path: db4_2_Level_fixdt/DWT_db4_2_Level/1st_Level_Decomp/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd
  ...
  wire signed [15:0] Add2_add_temp;  // sfix16_En27
  wire signed [15:0] Add2_out1;  // sfix16_En28
  reg signed [15:0] Delay2_out1;  // sfix16_En28
  wire signed [15:0] Add1_add_cast;  // sfix16_En27
  wire signed [15:0] Add1_add_cast_1;  // sfix16_En27
  wire signed [15:0] Add1_add_temp;  // sfix16_En27
  ...
  assign Multiply2_mul_temp = HiD_5_out1_1 * Rate_Transition2_out1;
  ...
  assign Multiply3_cast = {1'b0, Rate_Transition3_out1};
  ...
  assign Add2_add_cast_1 = {Multiply3_out1_1[3:0], 12'b000000000000};
  ...
  assign Add1_add_cast = {Multiply1_out1_1[3:0], 12'b000000000000};
  assign Add1_add_cast_1 = {Delay2_out1[15], Delay2_out1[15:1]};
  ...
  assign Add_add_cast_1 = {{5{Delay3_out1[15]}}, Delay3_out1[15:5]};
