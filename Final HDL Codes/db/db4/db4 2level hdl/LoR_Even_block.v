// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db4_2_Level_fixdt\LoR_Even_block.v
...
// Source Path: db4_2_Level_fixdt/DWT_db4_2_Level/2nd_Level_Recon/LoR_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoR_Even_block
  ...
  wire signed [15:0] Multiply1_out1;  // sfix16_En23
  reg signed [15:0] Multiply1_out1_1;  // sfix16_En23
  ...
  wire [15:0] LoR_6_out1;  // ufix16_En20
  reg [15:0] LoR_6_out1_1;  // ufix16_En20
  reg signed [15:0] Rate_Transition2_out1;  // sfix16_En23
  wire signed [16:0] Multiply3_cast;  // sfix17_En20
  ...
  assign LoR_0_out1 = 16'b1110101111101000;
  ...
  assign LoR_2_out1 = 16'b1010000110000001;
  ...
  assign LoR_4_out1 = 16'sb1010000000111101;
  ...
  assign LoR_6_out1 = 16'b1000011010110000;
