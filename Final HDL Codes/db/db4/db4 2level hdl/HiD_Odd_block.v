// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db4_2_Level_fixdt\HiD_Odd_block.v
...
// Source Path: db4_2_Level_fixdt/DWT_db4_2_Level/2nd_Level_Decomp/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd_block
  ...
  wire signed [15:0] HiD_3_out1;  // sfix16_En20
  reg signed [15:0] HiD_3_out1_1;  // sfix16_En20
  ...
  wire [15:0] HiD_5_out1;  // ufix16_En21
  reg [15:0] HiD_5_out1_1;  // ufix16_En21
  ...
  wire signed [15:0] HiD_7_out1;  // sfix16_En21
  reg signed [15:0] HiD_7_out1_1;  // sfix16_En21
  ...
  assign HiD_1_out1 = 16'b1011011100000000;
  ...
  assign HiD_3_out1 = 16'sb1000110101100001;
  ...
  always @(posedge clk)
    begin : reduced_1_process
      if (reset == 1'b1) begin
        ...
        if (enb) begin
          Rate_Transition1_out1 <= In_HiD_e_1;
        end
      end
    end


  assign Multiply1_mul_temp = HiD_3_out1_1 * Rate_Transition1_out1;
  ...
  assign HiD_5_out1 = 16'b1111110010100111;
  ...
  assign HiD_7_out1 = 16'sb1010100100110000;
  ...
  assign Multiply3_mul_temp = HiD_7_out1_1 * Rate_Transition3_out1;
  assign Multiply3_out1 = {{13{Multiply3_mul_temp[31]}}, Multiply3_mul_temp[31:29]};
  ...
  assign Add2_add_cast_1 = {Multiply3_out1_1[2:0], 13'b0000000000000};
  ...
  assign Add1_add_cast = {Multiply1_out1_1[2:0], 13'b0000000000000};
  ...
  assign Add_add_cast_1 = {{6{Delay3_out1[15]}}, Delay3_out1[15:6]};
