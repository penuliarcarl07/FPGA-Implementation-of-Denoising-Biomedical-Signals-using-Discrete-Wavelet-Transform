// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_4_Level_fixdt\alpha4th_Level_Recon.v
...
// -------------------------------------------------------------
// 
// Module: alpha4th_Level_Recon
// Source Path: db2_4_Level_fixdt/DWT_db2_4level/4th_Level_Recon
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha4th_Level_Recon
  ...
  wire signed [15:0] delayMatch_reg_next [0:122];  // sfix16_En27 [123]
  ...
  wire signed [15:0] delayMatch1_reg_next [0:122];  // sfix16_En27 [123]
  ...
  wire signed [32:0] HiR_mul_temp;  // sfix33_En39
  wire signed [31:0] HiR_cast_1;  // sfix32_En39
  ...
  LoR_Odd_block2 u_LoR_Odd (.clk(clk),
                            ...
                            .Out_HiR_o(LoR_Odd_out1)  // sfix16_En24
                            );
  assign Add1_add_cast = {{3{HiR_Odd_out1_1[15]}}, HiR_Odd_out1_1[15:3]};
  ...
  assign Add_add_cast = {{3{HiR_Even_out1_1[15]}}, HiR_Even_out1_1[15:3]};
  ...
  assign HiR_out1 = HiR_cast_1[31:16];
...
endmodule  // alpha4th_Level_Recon
