// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_4_Level_fixdt\DWT_db2_4level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_db2_4level
// Source Path: db2_4_Level_fixdt/DWT_db2_4level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_db2_4level
  ...
  reg signed [15:0] Rate_Transition2_out1;  // sfix16_En22
  ...
  reg signed [15:0] Rate_Transition3_out1;  // sfix16_En22
  wire signed [15:0] alpha2nd_Level_Decomp_out1;  // sfix16_En27
  wire [15:0] alpha2nd_Level_Decomp_out2;  // ufix16_En24
  wire [15:0] Threshold_Estimator_out1;  // ufix16_En25
  wire signed [15:0] Soft_Thresholding_out1;  // sfix16_En26
  wire signed [15:0] Soft_Thresholding1_out1;  // sfix16_En27
  reg [15:0] alpha2nd_Level_Decomp_out2_1;  // ufix16_En24
  reg [15:0] reduced_reg_1 [0:25];  // ufix16 [26]
  wire [15:0] reduced_reg_next_1 [0:25];  // ufix16_En24 [26]
  wire [15:0] alpha2nd_Level_Decomp_out2_2;  // ufix16_En24
  ...
  wire signed [15:0] alpha3rd_Level_Decomp_out1;  // sfix16_En27
  wire [15:0] alpha3rd_Level_Decomp_out2;  // ufix16_En24
  wire signed [15:0] Soft_Thresholding2_out1;  // sfix16_En27
  reg [15:0] alpha3rd_Level_Decomp_out2_1;  // ufix16_En24
  reg [15:0] reduced_reg_2 [0:25];  // ufix16 [26]
  wire [15:0] reduced_reg_next_2 [0:25];  // ufix16_En24 [26]
  wire [15:0] alpha3rd_Level_Decomp_out2_2;  // ufix16_En24
  ...
  wire signed [15:0] alpha4th_Level_Decomp_out1;  // sfix16_En27
  wire [15:0] alpha4th_Level_Decomp_out2;  // ufix16_En24
  wire signed [15:0] Soft_Thresholding3_out1;  // sfix16_En27
  wire signed [15:0] alpha1st_Level_Recon_out1;  // sfix16_En23
  wire signed [15:0] alpha2nd_Level_Recon_out1;  // sfix16_En23
  wire signed [15:0] alpha3rd_Level_Recon_out1;  // sfix16_En23
  wire signed [15:0] alpha4th_Level_Recon_out1;  // sfix16_En23


  DWT_db2_4level_tc u_DWT_db2_4level_tc (.clk(clk),
                                         .reset(reset),
  ...
  always @(posedge clk)
    begin : Rate_Transition_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition_out1 <= Downsample4_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition2_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition2_out1 <= Downsample1_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition3_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition3_out1 <= Downsample3_out1_1;
        end
      end
    end
  ...
  alpha2nd_Level_Decomp u_2nd_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(Rate_Transition2_out1),  // sfix16_En22
                                            .In_O(Rate_Transition3_out1),  // sfix16_En22
                                            .Out_HiD(alpha2nd_Level_Decomp_out1),  // sfix16_En27
                                            .Out_LoD(alpha2nd_Level_Decomp_out2)  // ufix16_En24
                                            );
  Threshold_Estimator u_Threshold_Estimator (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .Signal_w(alpha2nd_Level_Decomp_out1),  // sfix16_En27
  ...
  always @(posedge clk)
    begin : reduced_2_process
      if (reset == 1'b1) begin
        alpha2nd_Level_Decomp_out2_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          alpha2nd_Level_Decomp_out2_1 <= alpha2nd_Level_Decomp_out2;
        end
      end
    end
  ...
  assign alpha2nd_Level_Decomp_out2_2 = reduced_reg_1[25];
  assign reduced_reg_next_1[0] = alpha2nd_Level_Decomp_out2_1;
  ...
  always @(posedge clk)
    begin : Downsample5_output_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_1) begin
          Downsample5_out1 <= alpha2nd_Level_Decomp_out2_2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition4_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition4_out1 <= Downsample5_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Downsample6_ds_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_4) begin
          Downsample6_ds_out <= alpha2nd_Level_Decomp_out2_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition5_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition5_out1 <= Downsample6_out1_1;
        end
      end
    end


  alpha3rd_Level_Decomp u_3rd_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(Rate_Transition4_out1),  // ufix16_En24
                                            .In_O(Rate_Transition5_out1),  // ufix16_En24
                                            .Out_HiD(alpha3rd_Level_Decomp_out1),  // sfix16_En27
                                            .Out_LoD(alpha3rd_Level_Decomp_out2)  // ufix16_En24
                                            );
  Soft_Thresholding2 u_Soft_Thresholding2 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .Signal_w(alpha3rd_Level_Decomp_out1),  // sfix16_En27
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En25
  ...
  always @(posedge clk)
    begin : reduced_4_process
      if (reset == 1'b1) begin
        alpha3rd_Level_Decomp_out2_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          alpha3rd_Level_Decomp_out2_1 <= alpha3rd_Level_Decomp_out2;
        end
      end
    end
  ...
  assign alpha3rd_Level_Decomp_out2_2 = reduced_reg_2[25];
  assign reduced_reg_next_2[0] = alpha3rd_Level_Decomp_out2_1;
  ...
  always @(posedge clk)
    begin : Downsample7_output_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_1) begin
          Downsample7_out1 <= alpha3rd_Level_Decomp_out2_2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition6_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition6_out1 <= Downsample7_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Downsample8_ds_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_4) begin
          Downsample8_ds_out <= alpha3rd_Level_Decomp_out2_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition7_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition7_out1 <= Downsample8_out1_1;
        end
      end
    end


  alpha4th_Level_Decomp u_4th_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(Rate_Transition6_out1),  // ufix16_En24
                                            .In_O(Rate_Transition7_out1),  // ufix16_En24
                                            .Out_HiD(alpha4th_Level_Decomp_out1),  // sfix16_En27
                                            .Out_LoD(alpha4th_Level_Decomp_out2)  // ufix16_En24
                                            );
  Soft_Thresholding3 u_Soft_Thresholding3 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .Signal_w(alpha4th_Level_Decomp_out1),  // sfix16_En27
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En25
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha4th_Level_Decomp_out2),  // ufix16_En24
  ...
  alpha2nd_Level_Recon u_2nd_Level_Recon (.clk(clk),
                                          ...
                                          .Out(alpha2nd_Level_Recon_out1)  // sfix16_En23
                                          );
  alpha3rd_Level_Recon u_3rd_Level_Recon (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .In_HiD(Soft_Thresholding1_out1),  // sfix16_En27
                                          .In_LoD(alpha2nd_Level_Recon_out1),  // sfix16_En23
                                          .Out(alpha3rd_Level_Recon_out1)  // sfix16_En23
                                          );
  alpha4th_Level_Recon u_4th_Level_Recon (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .In_HiD(Soft_Thresholding_out1),  // sfix16_En26
                                          .In_LoD(alpha3rd_Level_Recon_out1),  // sfix16_En23
                                          .Out(alpha4th_Level_Recon_out1)  // sfix16_En23
                                          );
  assign Out1 = alpha4th_Level_Recon_out1;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_db2_4level
