// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_4_Level_fixdt\alpha2nd_Level_Recon.v
...
// Source Path: db2_4_Level_fixdt/DWT_db2_4level/2nd_Level_Recon
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha2nd_Level_Recon
  ...
  reg signed [15:0] delayMatch_reg [0:62];  // sfix16 [63]
  wire signed [15:0] delayMatch_reg_next [0:62];  // sfix16_En27 [63]
  wire signed [15:0] HiR_Even_out1_1;  // sfix16_En27
  wire signed [15:0] HiR_Odd_out1;  // sfix16_En28
  reg signed [15:0] delayMatch1_reg [0:62];  // sfix16 [63]
  wire signed [15:0] delayMatch1_reg_next [0:62];  // sfix16_En28 [63]
  ...
  assign HiR_Even_out1_1 = delayMatch_reg[62];
  ...
  assign HiR_Odd_out1_1 = delayMatch1_reg[62];
...
endmodule  // alpha2nd_Level_Recon
