// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\LoR_Odd_block3.v
...
// -------------------------------------------------------------
// 
// Module: LoR_Odd_block3
// Source Path: db2_level5_final_hdlsss/DWT_db2_5_level/1st_Level_Recon4/LoR_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoR_Odd_block3
  ...
  reg signed [15:0] In_LoR_o_1;  // sfix16_En22
  ...
  reg signed [15:0] RT_out1;  // sfix16_En22
  ...
  assign LoR_1_out1 = 16'b1101011000100110;
  ...
  assign LoR_3_out1 = 16'sb1011110110111110;
  ...
  assign Multiply1_mul_temp = LoR_3_out1_1 * RT_out1;
  ...
  assign Add_add_cast = {{2{Multiply1_out1_1[15]}}, Multiply1_out1_1[15:2]};
  assign Add_out1 = Multiply_out1_1 + Add_add_cast;


  assign Out_HiR_o = Add_out1;

endmodule  // LoR_Odd_block3
