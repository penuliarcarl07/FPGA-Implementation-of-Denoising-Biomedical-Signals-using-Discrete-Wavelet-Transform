// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\DWT_db2_5_level_tb.v
// Created: 2024-04-18 07:00:00
// 
...
module DWT_db2_5_level_tb;
  ...
  reg [13:0] Data_Type_Conversion1_out1_addr;  // ufix14
  wire Data_Type_Conversion1_out1_active;  // ufix1
  reg  tb_enb_delay;
  wire Data_Type_Conversion1_out1_enb;  // ufix1
  wire [13:0] Data_Type_Conversion1_out1_addr_delay_1;  // ufix14
  reg signed [31:0] fp_Input_Sound;  // sfix32
  reg [15:0] rawData_Input_Sound;  // ufix16_En23
  reg signed [31:0] status_Input_Sound;  // sfix32
  reg [15:0] holdData_Input_Sound;  // ufix16_En23
  reg [15:0] Input_Sound_offset;  // ufix16_En23
  wire [15:0] Input_Sound;  // ufix16_En23
  ...
  assign Out1_active = Out1_addr != 14'b10001001110100;



  assign Data_Type_Conversion1_out1_active = Data_Type_Conversion1_out1_addr != 14'b10001001110100;



  assign Data_Type_Conversion1_out1_enb = Data_Type_Conversion1_out1_active & (tb_enb_delay & tb_enb_delay);
  ...
  always @(posedge clk)
    begin : DataTypeConversion1_process
      if (reset == 1'b1) begin
        Data_Type_Conversion1_out1_addr <= 14'b00000000000000;
      end
      else begin
        if (Data_Type_Conversion1_out1_enb) begin
          if (Data_Type_Conversion1_out1_addr >= 14'b10001001110100) begin
            Data_Type_Conversion1_out1_addr <= 14'b00000000000000;
          end
          else begin
            Data_Type_Conversion1_out1_addr <= Data_Type_Conversion1_out1_addr + 14'b00000000000001;
          end
        end
      end
    end
  ...
  // Data source for Input_Sound
  initial
    begin : Input_Sound_fileread
      fp_Input_Sound = $fopen("Input_Sound.dat", "r");
      status_Input_Sound = $rewind(fp_Input_Sound);
    end

  always @(Data_Type_Conversion1_out1_addr_delay_1, tb_enb_delay, tb_enb_delay)
    begin
      if (tb_enb_delay == 0) begin
        rawData_Input_Sound <= 16'bx;
      end
      else if (tb_enb_delay == 1) begin
        status_Input_Sound = $fscanf(fp_Input_Sound, "%h", rawData_Input_Sound);
      end
    end
  ...
  always @(posedge clk)
    begin : stimuli_Data_Type_Conversion1_out1
      if (reset) begin
        holdData_Input_Sound <= 16'bx;
      end
      else begin
        holdData_Input_Sound <= rawData_Input_Sound;
      end
    end

  always @(rawData_Input_Sound or tb_enb_delay)
    begin : stimuli_Data_Type_Conversion1_out1_1
      if (tb_enb_delay == 1'b0) begin
        Input_Sound_offset <= holdData_Input_Sound;
      end
      else begin
        Input_Sound_offset <= rawData_Input_Sound;
      end
    end

  assign #2 Input_Sound = Input_Sound_offset;
  ...
  DWT_db2_5_level u_DWT_db2_5_level (.clk(clk),
                                     .reset(reset),
  ...
  always @(posedge clk)
    begin : c_2_process
      if (reset == 1'b1) begin
        ...
        if (Out1_enb) begin
          if (Out1_addr >= 14'b10001001110100) begin
            Out1_addr <= 14'b00000000000000;
          end
          else begin
  ...
  assign Out1_lastAddr = Out1_addr >= 14'b10001001110100;
