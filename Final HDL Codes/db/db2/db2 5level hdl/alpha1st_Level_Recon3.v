// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\alpha1st_Level_Recon3.v
...
// -------------------------------------------------------------
// 
// Module: alpha1st_Level_Recon3
// Source Path: db2_level5_final_hdlsss/DWT_db2_5_level/1st_Level_Recon3
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon3
  ...
  reg signed [15:0] delayMatch_reg [0:182];  // sfix16 [183]
  wire signed [15:0] delayMatch_reg_next [0:182];  // sfix16_En28 [183]
  ...
  reg signed [15:0] delayMatch1_reg [0:182];  // sfix16 [183]
  wire signed [15:0] delayMatch1_reg_next [0:182];  // sfix16_En29 [183]
  ...
  HiR_Even_block2 u_HiR_Even (.clk(clk),
                              .reset(reset),
                              .enb(enb),
  ...
  assign HiR_Even_out1_1 = delayMatch_reg[182];
  ...
  LoR_Even_block2 u_LoR_Even (.clk(clk),
                              .reset(reset),
                              .enb(enb),
  ...
  HiR_Odd_block2 u_HiR_Odd (.clk(clk),
                            .reset(reset),
                            .enb(enb),
  ...
  assign HiR_Odd_out1_1 = delayMatch1_reg[182];
  ...
  LoR_Odd_block2 u_LoR_Odd (.clk(clk),
                            .reset(reset),
                            .enb(enb),
...
endmodule  // alpha1st_Level_Recon3
