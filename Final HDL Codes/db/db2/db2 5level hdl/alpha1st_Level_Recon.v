// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\alpha1st_Level_Recon.v
...
// Source Path: db2_level5_final_hdlsss/DWT_db2_5_level/1st_Level_Recon
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon
  ...
  reg [15:0] LoR_Odd_out1_1;  // ufix16_En25
  ...
  always @(posedge clk)
    begin : delayMatch1_process
      if (reset == 1'b1) begin
        LoR_Odd_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
