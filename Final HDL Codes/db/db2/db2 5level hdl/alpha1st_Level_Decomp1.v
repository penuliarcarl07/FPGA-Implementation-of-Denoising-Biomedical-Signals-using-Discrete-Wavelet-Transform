// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\alpha1st_Level_Decomp1.v
...
// Source Path: db2_level5_final_hdlsss/DWT_db2_5_level/1st_Level_Decomp1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Decomp1
  ...
  reg [15:0] Downsample_out1;  // ufix16_En23
  reg [15:0] Downsample_out1_1;  // ufix16_En23
  ...
  reg signed [15:0] Gain1_out1_1;  // sfix16_En22
  ...
  HiD_Even u_HiD_Even (.clk(clk),
                       .reset(reset),
                       .enb(enb),
                       .In_HiD_e(Rate_Transition_out1),  // ufix16_En23
  ...
  HiD_Odd u_HiD_Odd (.clk(clk),
                     .reset(reset),
                     .enb(enb),
                     .In_HiD_o(Rate_Transition1_out1),  // ufix16_En23
  ...
  LoD_Even u_LoD_Even (.clk(clk),
                       .reset(reset),
                       .enb(enb),
                       .In_LoD_e(Rate_Transition_out1),  // ufix16_En23
                       .Out_LoD_e(LoD_Even_out1)  // sfix16_En23
                       );
  LoD_Odd u_LoD_Odd (.clk(clk),
                     .reset(reset),
                     .enb(enb),
                     .In_LoD_o(Rate_Transition1_out1),  // ufix16_En23
