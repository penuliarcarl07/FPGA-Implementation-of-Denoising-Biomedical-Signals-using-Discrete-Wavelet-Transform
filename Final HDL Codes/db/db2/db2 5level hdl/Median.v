// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_level5_final_hdlsss\Median.v
...
// 
// Module: Median
// Source Path: db2_level5_final_hdlsss/DWT_db2_5_level/Threshold_Estimator/Median
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Median
  ...
  input   reset;
  input   enb;
  input   [15:0] In_Abs;  // ufix16_En28
  output  [15:0] Median_1;  // ufix16_En28
  ...
  Data_Sorter2 u_Data_Sorter2 (.clk(clk),
                               .reset(reset),
                               .enb(enb),
                               .Signal1(Delay3_out1),  // ufix16_En28
                               .Signal2(Delay4_out1),  // ufix16_En28
  ...
  Data_Sorter3 u_Data_Sorter3 (.clk(clk),
                               .reset(reset),
                               .enb(enb),
                               .Signal1(Delay5_out1),  // ufix16_En28
                               .Signal2(Delay6_out1),  // ufix16_En28
