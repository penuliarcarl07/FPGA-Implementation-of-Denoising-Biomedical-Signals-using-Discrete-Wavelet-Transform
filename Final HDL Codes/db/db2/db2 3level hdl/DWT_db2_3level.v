// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_3_Level_fixdt\DWT_db2_3level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_db2_3level
// Source Path: db2_3_Level_fixdt/DWT_db2_3level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_db2_3level
  ...
  DWT_db2_3level_tc u_DWT_db2_3level_tc (.clk(clk),
                                         .reset(reset),
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha3rd_Level_Decomp_out2),  // ufix16_En24
  ...
  assign Out1 = alpha3rd_Level_Recon_out1;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_db2_3level
