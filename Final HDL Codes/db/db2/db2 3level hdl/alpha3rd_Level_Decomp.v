// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db2_3_Level_fixdt\alpha3rd_Level_Decomp.v
...
// -------------------------------------------------------------
// 
// Module: alpha3rd_Level_Decomp
// Source Path: db2_3_Level_fixdt/DWT_db2_3level/3rd_Level_Decomp
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha3rd_Level_Decomp
  ...
  wire signed [32:0] HiD_mul_temp;  // sfix33_En42
  wire signed [31:0] HiD_cast_1;  // sfix32_En42
  wire signed [15:0] HiD_out1;  // sfix16_En27
  reg signed [15:0] HiD_out1_1;  // sfix16_En27
  ...
  wire [31:0] LoD_mul_temp;  // ufix32_En39
  wire [15:0] LoD_out1;  // ufix16_En24
  reg [15:0] LoD_out1_1;  // ufix16_En24
  ...
  assign HiD_out1 = HiD_cast_1[30:15];
  ...
  assign LoD_mul_temp = kconst_3 * Add1_out1_1;
  assign LoD_out1 = LoD_mul_temp[30:15];


  always @(posedge clk)
    begin : PipelineRegister1_process
      if (reset == 1'b1) begin
        LoD_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          LoD_out1_1 <= LoD_out1;
...
endmodule  // alpha3rd_Level_Decomp
