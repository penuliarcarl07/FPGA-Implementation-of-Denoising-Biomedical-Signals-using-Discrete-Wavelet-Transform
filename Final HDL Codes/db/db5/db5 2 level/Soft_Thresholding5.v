// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\Soft_Thresholding5.v
...
// Source Path: db5_2level_final_hdl/DWT_db5_2level/Soft_Thresholding5
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Soft_Thresholding5
  ...
  wire [15:0] kconst;  // ufix16_En17
  reg [15:0] kconst_1;  // ufix16_En17
  reg signed [15:0] reduced_reg [0:63];  // sfix16 [64]
  wire signed [15:0] reduced_reg_next [0:63];  // sfix16_En24 [64]
  wire signed [15:0] Signal_w_1;  // sfix16_En24
  wire signed [34:0] Relational_Operator7_1_cast;  // sfix35_En27
  wire signed [34:0] Relational_Operator7_1_cast_1;  // sfix35_En27
  wire Relational_Operator7_relop1;
  wire signed [34:0] Relational_Operator2_1_cast;  // sfix35_En27
  wire signed [34:0] Relational_Operator2_1_cast_1;  // sfix35_En27
  ...
  wire signed [15:0] reduced_reg_next_1 [0:1];  // sfix16_En24 [2]
  wire signed [15:0] Signal_w_2;  // sfix16_En24
  ...
  wire [15:0] delayMatch_reg_next [0:63];  // ufix16_En25 [64]
  wire [15:0] Abs_out1_1;  // ufix16_En25
  wire [35:0] Relational_Operator1_1_cast;  // ufix36_En27
  wire [35:0] Relational_Operator1_1_cast_1;  // ufix36_En27
  wire Relational_Operator1_relop1;
  reg  Delay5_out1;
  wire signed [34:0] Relational_Operator5_1_cast;  // sfix35_En27
  wire signed [34:0] Relational_Operator5_1_cast_1;  // sfix35_En27
  ...
  wire signed [16:0] Gain_cast;  // sfix17_En17
  wire signed [32:0] Gain_mul_temp;  // sfix33_En41
  wire signed [31:0] Gain_cast_1;  // sfix32_En41
  wire signed [15:0] Gain_out1;  // sfix16_En26
  reg signed [15:0] Gain_out1_1;  // sfix16_En26


  assign kconst = 16'b0110111101000101;
  ...
  assign Relational_Operator7_1_cast = {{16{Signal_w_1[15]}}, {Signal_w_1, 3'b000}};
  ...
  assign Relational_Operator2_1_cast = {{16{Signal_w_1[15]}}, {Signal_w_1, 3'b000}};
  ...
  assign Relational_Operator3_1_cast = {{9{Signal_w_2[15]}}, Signal_w_2};
  assign Relational_Operator3_1_cast_1 = {Gain1_out1_1, 9'b000000000};
  ...
  assign Add1_add_cast = {3'b0, Threshold1[15:3]};
  ...
  assign Subtract1_sub_cast = {3'b0, Threshold1[15:3]};
  ...
  assign Relational_Operator1_1_cast = {18'b0, {Abs_out1_1, 2'b00}};
  assign Relational_Operator1_1_cast_1 = {20'b0, Threshold1};
  ...
  assign Relational_Operator5_1_cast = {{16{Signal_w_1[15]}}, {Signal_w_1, 3'b000}};
