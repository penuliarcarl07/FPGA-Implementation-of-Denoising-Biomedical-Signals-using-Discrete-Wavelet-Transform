// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\LoD_Odd.v
...
// 
// Module: LoD_Odd
// Source Path: db5_2level_final_hdl/DWT_db5_2level/1st_Level_Decomp5/LoD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Odd
  ...
  wire [15:0] Add3_add_cast;  // ufix16_En23
  wire [15:0] Add3_add_cast_1;  // ufix16_En23
  wire [15:0] Add3_out1;  // ufix16_En23
  reg [15:0] Delay4_out1;  // ufix16_En23
  wire signed [15:0] Add2_add_cast;  // sfix16_En22
  wire signed [15:0] Add2_add_cast_1;  // sfix16_En22
  wire signed [15:0] Add2_add_temp;  // sfix16_En22
  ...
  assign Multiply2_out1 = {{9{Multiply2_cast_1[31]}}, Multiply2_cast_1[31:25]};
  ...
  assign Multiply4_mul_temp = LoD_9_out1_1 * Rate_Transition3_out1;
  ...
  assign Add2_add_cast = {Multiply2_out1_1[8:0], 7'b0000000};
