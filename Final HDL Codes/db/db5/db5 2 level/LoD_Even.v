// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\LoD_Even.v
...
// 
// Module: LoD_Even
// Source Path: db5_2level_final_hdl/DWT_db5_2level/1st_Level_Decomp5/LoD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Even
  ...
  wire [15:0] Multiply_out1;  // ufix16_En31
  reg [15:0] Multiply_out1_1;  // ufix16_En31
  ...
  wire signed [32:0] Multiply1_mul_temp;  // sfix33_En45
  wire signed [31:0] Multiply1_cast_1;  // sfix32_En45
  ...
  wire [15:0] Multiply3_out1;  // ufix16_En26
  reg [15:0] Multiply3_out1_1;  // ufix16_En26
  wire [15:0] LoD_8_out1;  // ufix16_En16
  reg [15:0] LoD_8_out1_1;  // ufix16_En16
  reg [15:0] Rate_Transition3_out1;  // ufix16_En23
  wire [31:0] Multiply4_mul_temp;  // ufix32_En39
  ...
  assign Multiply1_out1 = {{14{Multiply1_cast_1[31]}}, Multiply1_cast_1[31:30]};
  ...
  assign Add3_add_cast = {2'b0, Multiply3_out1_1[15:2]};
