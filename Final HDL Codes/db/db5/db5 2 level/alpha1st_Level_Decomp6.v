// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\alpha1st_Level_Decomp6.v
...
// Source Path: db5_2level_final_hdl/DWT_db5_2level/1st_Level_Decomp6
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Decomp6
  ...
  HiD_Even_block u_HiD_Even (.clk(clk),
                             .reset(reset),
                             .enb(enb),
                             .In_HiD_e(Rate_Transition1_out1),  // sfix16_En23
  ...
  HiD_Odd_block u_HiD_Odd (.clk(clk),
                           .reset(reset),
                           .enb(enb),
                           .In_HiD_e(Rate_Transition2_out1),  // sfix16_En23
