// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\LoD_Odd_block.v
...
// Source Path: db5_2level_final_hdl/DWT_db5_2level/1st_Level_Decomp6/LoD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Odd_block
  ...
  wire signed [15:0] LoD_1_out1;  // sfix16_En21
  reg signed [15:0] LoD_1_out1_1;  // sfix16_En21
  ...
  wire [15:0] LoD_3_out1;  // ufix16_En19
  reg [15:0] LoD_3_out1_1;  // ufix16_En19
  reg signed [15:0] Rate_Transition_out1;  // sfix16_En23
  wire signed [16:0] Multiply1_cast;  // sfix17_En19
  ...
  wire signed [15:0] LoD_5_out1;  // sfix16_En17
  reg signed [15:0] LoD_5_out1_1;  // sfix16_En17
  ...
  wire [15:0] LoD_7_out1;  // ufix16_En16
  reg [15:0] LoD_7_out1_1;  // ufix16_En16
  reg signed [15:0] Rate_Transition2_out1;  // sfix16_En23
  wire signed [16:0] Multiply3_cast;  // sfix17_En16
  wire signed [32:0] Multiply3_mul_temp;  // sfix33_En39
  wire signed [31:0] Multiply3_cast_1;  // sfix32_En39
  wire [15:0] Multiply3_out1;  // ufix16_En24
  reg [15:0] Multiply3_out1_1;  // ufix16_En24
  wire [15:0] LoD_9_out1;  // ufix16_En18
  reg [15:0] LoD_9_out1_1;  // ufix16_En18
  reg signed [15:0] Rate_Transition3_out1;  // sfix16_En23
  wire signed [16:0] Multiply4_cast;  // sfix17_En18
  ...
  assign LoD_1_out1 = 16'sb1001100011110000;
  ...
  assign Multiply_out1 = {{13{Multiply_mul_temp[31]}}, Multiply_mul_temp[31:29]};
  ...
  assign LoD_3_out1 = 16'b1001111011011110;
  ...
  assign LoD_5_out1 = 16'sb1000001111110010;
  ...
  assign Multiply2_out1 = {{9{Multiply2_mul_temp[31]}}, Multiply2_mul_temp[31:25]};
  ...
  assign LoD_7_out1 = 16'b1011100101101100;
  ...
  assign Multiply3_cast = {1'b0, LoD_7_out1_1};
  ...
  assign LoD_9_out1 = 16'b1010001111110010;
  ...
  assign Add3_add_cast = {2'b0, Multiply4_out1_1[15:2]};
  ...
  assign Add1_add_cast = {4'b0, Multiply1_out1_1[15:4]};
