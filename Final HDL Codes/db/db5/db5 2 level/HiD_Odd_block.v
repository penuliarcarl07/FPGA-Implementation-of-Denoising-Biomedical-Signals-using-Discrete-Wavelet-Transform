// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\HiD_Odd_block.v
...
// Source Path: db5_2level_final_hdl/DWT_db5_2level/1st_Level_Decomp6/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd_block
  ...
  wire [15:0] Multiply4_out1;  // ufix16_En32
  reg [15:0] delayMatch_reg [0:1];  // ufix16 [2]
  wire [15:0] delayMatch_reg_next [0:1];  // ufix16_En32 [2]
  wire [15:0] Multiply4_out1_1;  // ufix16_En32
  ...
  reg signed [15:0] Delay4_out1;  // sfix16_En31
  ...
  assign Multiply3_out1 = {{14{Multiply3_mul_temp[31]}}, Multiply3_mul_temp[31:30]};
  ...
  assign Add3_add_cast_1 = {2'b0, Multiply4_out1_1[15:2]};
  ...
  assign Add2_add_cast = {Multiply2_out1_1[2:0], 13'b0000000000000};
