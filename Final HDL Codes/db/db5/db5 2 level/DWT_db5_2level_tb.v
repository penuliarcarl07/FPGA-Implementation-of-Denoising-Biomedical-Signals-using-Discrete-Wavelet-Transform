// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db5_2level_final_hdl\DWT_db5_2level_tb.v
// Created: 2024-04-17 05:57:07
// 
...
module DWT_db5_2level_tb;
  ...
  reg [8:0] Data_Type_Conversion_out1_addr;  // ufix9
  wire Data_Type_Conversion_out1_active;  // ufix1
  reg  tb_enb_delay;
  wire Data_Type_Conversion_out1_enb;  // ufix1
  wire [8:0] Data_Type_Conversion_out1_addr_delay_1;  // ufix9
  reg signed [31:0] fp_In_E;  // sfix32
  reg [15:0] rawData_In_E;  // ufix16_En23
  reg signed [31:0] status_In_E;  // sfix32
  reg [15:0] holdData_In_E;  // ufix16_En23
  reg [15:0] In_E_offset;  // ufix16_En23
  wire [15:0] In_E;  // ufix16_En23
  ...
  assign Out1_active = Out1_addr != 9'b110111001;



  assign Data_Type_Conversion_out1_active = Data_Type_Conversion_out1_addr != 9'b110111001;
  ...
  always @(posedge clk)
    begin : DataTypeConversion_process
      if (reset == 1'b1) begin
        Data_Type_Conversion_out1_addr <= 9'b000000000;
      end
      else begin
        if (Data_Type_Conversion_out1_enb) begin
          if (Data_Type_Conversion_out1_addr >= 9'b110111001) begin
            Data_Type_Conversion_out1_addr <= 9'b000000000;
          end
          else begin
            Data_Type_Conversion_out1_addr <= Data_Type_Conversion_out1_addr + 9'b000000001;
          end
        end
      end
    end
  ...
  DWT_db5_2level u_DWT_db5_2level (.clk(clk),
                                   .reset(reset),
  ...
  always @(posedge clk)
    begin : c_2_process
      if (reset == 1'b1) begin
        ...
        if (Out1_enb) begin
          if (Out1_addr >= 9'b110111001) begin
            Out1_addr <= 9'b000000000;
          end
          else begin
  ...
  assign Out1_lastAddr = Out1_addr >= 9'b110111001;
