// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\alpha1st_Level_Recon1.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Recon1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon1
  ...
  wire signed [15:0] HiR_Even_out1;  // sfix16_En26
  reg signed [15:0] delayMatch_reg [0:56];  // sfix16 [57]
  wire signed [15:0] delayMatch_reg_next [0:56];  // sfix16_En26 [57]
  wire signed [15:0] HiR_Even_out1_1;  // sfix16_En26
  wire signed [15:0] LoR_Even_out1;  // sfix16_En24
  wire signed [15:0] Add_add_cast;  // sfix16_En24
  wire signed [15:0] Add_out1;  // sfix16_En24
  wire signed [15:0] HiR_Odd_out1;  // sfix16_En26
  reg signed [15:0] delayMatch1_reg [0:56];  // sfix16 [57]
  wire signed [15:0] delayMatch1_reg_next [0:56];  // sfix16_En26 [57]
  wire signed [15:0] HiR_Odd_out1_1;  // sfix16_En26
  ...
  assign kconst = 16'b1000110001000011;
  ...
  HiR_Even_block u_HiR_Even (.clk(clk),
                             ...
                             .Out_HiR_e(HiR_Even_out1)  // sfix16_En26
                             );
  always @(posedge clk)
  ...
  assign HiR_Even_out1_1 = delayMatch_reg[56];
  ...
  assign Add_add_cast = {{2{HiR_Even_out1_1[15]}}, HiR_Even_out1_1[15:2]};
  ...
  HiR_Odd_block u_HiR_Odd (.clk(clk),
                           ...
                           .Out_HiR_o(HiR_Odd_out1)  // sfix16_En26
                           );
  always @(posedge clk)
  ...
  assign HiR_Odd_out1_1 = delayMatch1_reg[56];
  ...
  assign Add1_add_cast = {{2{HiR_Odd_out1_1[15]}}, HiR_Odd_out1_1[15:2]};
