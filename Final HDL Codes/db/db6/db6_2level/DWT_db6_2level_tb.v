// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\DWT_db6_2level_tb.v
// Created: 2024-04-17 20:20:36
// 
...
module DWT_db6_2level_tb;
  ...
  reg [16:0] Out1_addr;  // ufix17
  wire Out1_active;  // ufix1
  reg [16:0] Data_Type_Conversion_out1_addr;  // ufix17
  wire Data_Type_Conversion_out1_active;  // ufix1
  reg  tb_enb_delay;
  wire Data_Type_Conversion_out1_enb;  // ufix1
  wire [16:0] Data_Type_Conversion_out1_addr_delay_1;  // ufix17
  ...
  wire [16:0] Out1_addr_delay_1;  // ufix17
  ...
  assign Out1_active = Out1_addr != 17'b10101100010001000;



  assign Data_Type_Conversion_out1_active = Data_Type_Conversion_out1_addr != 17'b10101100010001000;
  ...
  //  initial value   = 0
  //  step value      = 1
  //  count to value  = 88200
  always @(posedge clk)
    begin : DataTypeConversion_process
      if (reset == 1'b1) begin
        Data_Type_Conversion_out1_addr <= 17'b00000000000000000;
      end
      else begin
        if (Data_Type_Conversion_out1_enb) begin
          if (Data_Type_Conversion_out1_addr >= 17'b10101100010001000) begin
            Data_Type_Conversion_out1_addr <= 17'b00000000000000000;
          end
          else begin
            Data_Type_Conversion_out1_addr <= Data_Type_Conversion_out1_addr + 17'b00000000000000001;
          end
        end
      end
    end
  ...
  DWT_db6_2level u_DWT_db6_2level (.clk(clk),
                                   .reset(reset),
  ...
  always @(posedge clk)
    begin : c_2_process
      if (reset == 1'b1) begin
        Out1_addr <= 17'b00000000000000000;
      end
      else begin
        if (Out1_enb) begin
          if (Out1_addr >= 17'b10101100010001000) begin
            Out1_addr <= 17'b00000000000000000;
          end
          else begin
            Out1_addr <= Out1_addr + 17'b00000000000000001;
          end
        end
      end
    end
  ...
  assign Out1_lastAddr = Out1_addr >= 17'b10101100010001000;
