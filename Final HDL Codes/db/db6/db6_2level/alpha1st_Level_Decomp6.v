// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\alpha1st_Level_Decomp6.v
...
// -------------------------------------------------------------
// 
// Module: alpha1st_Level_Decomp6
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Decomp6
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Decomp6
  ...
  reg signed [15:0] In_E_1;  // sfix16_En24
  reg signed [15:0] reduced_reg [0:25];  // sfix16 [26]
  wire signed [15:0] reduced_reg_next [0:25];  // sfix16_En24 [26]
  wire signed [15:0] In_E_2;  // sfix16_En24
  reg signed [15:0] Downsample1_out1;  // sfix16_En24
  reg signed [15:0] Downsample1_out1_1;  // sfix16_En24
  reg signed [15:0] Rate_Transition_out1;  // sfix16_En24
  wire signed [15:0] HiD_Even_out1;  // sfix16_En15
  reg signed [15:0] Downsample2_ds_out;  // sfix16_En24
  reg signed [15:0] Downsample2_out1;  // sfix16_En24
  reg signed [15:0] Downsample2_out1_1;  // sfix16_En24
  ...
  wire [15:0] kconst_2;  // ufix16_En17
  reg [15:0] kconst_3;  // ufix16_En17
  ...
  wire signed [16:0] Gain1_cast;  // sfix17_En17
  ...
  assign kconst = 16'b1110100110111100;
  ...
  HiD_Even_block u_HiD_Even (.clk(clk),
                             .reset(reset),
                             .enb(enb),
                             .In_HiD_e(Rate_Transition_out1),  // sfix16_En24
  ...
  HiD_Odd_block u_HiD_Odd (.clk(clk),
                           .reset(reset),
                           .enb(enb),
                           .In_HiD_o(Rate_Transition1_out1),  // sfix16_En24
                           .Out_HiD_o(HiD_Odd_out1)  // ufix16_En25
                           );
  assign Add_add_cast = {HiD_Even_out1[6:0], 9'b000000000};
  ...
  assign kconst_2 = 16'b1110100110011111;
  ...
  LoD_Even_block u_LoD_Even (.clk(clk),
                             .reset(reset),
                             .enb(enb),
                             .In_LoD_e(Rate_Transition_out1),  // sfix16_En24
                             .Out_LoD_e(LoD_Even_out1)  // sfix16_En24
                             );
  LoD_Odd_block u_LoD_Odd (.clk(clk),
                           .reset(reset),
                           .enb(enb),
                           .In_LoD_o(Rate_Transition1_out1),  // sfix16_En24
  ...
  assign Gain1_out1 = Gain1_cast_1[31:16];
...
endmodule  // alpha1st_Level_Decomp6
