// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\Soft_Thresholding6.v
...
// -------------------------------------------------------------
// 
// Module: Soft_Thresholding6
// Source Path: db6_2level_final_hdl/DWT_db6_2level/Soft_Thresholding6
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Soft_Thresholding6
  ...
  wire [15:0] reduced_reg_next [0:54];  // ufix16_En24 [55]
  wire [15:0] Threshold1_2;  // ufix16_En24
  ...
  wire [35:0] Relational_Operator1_1_cast;  // ufix36_En28
  wire [35:0] Relational_Operator1_1_cast_1;  // ufix36_En28
  ...
  wire signed [15:0] Threshold_Switch_out1;  // sfix16_En23
  wire signed [15:0] Threshold_Switch1_out1;  // sfix16_En4
  wire signed [15:0] Threshold_Switch1_out1_dtc;  // sfix16_En23
  wire signed [15:0] Threshold_Switch2_out1;  // sfix16_En23
  reg signed [15:0] Threshold_Switch2_out1_1;  // sfix16_En23
  ...
  assign Relational_Operator2_1_cast = {{20{Signal_w[15]}}, Signal_w};
  assign Relational_Operator2_1_cast_1 = {17'b0, {Threshold1_2, 3'b000}};
  ...
  assign Add1_add_cast = {{4{Signal_w[15]}}, Signal_w[15:4]};
  ...
  assign Subtract1_sub_cast = {{4{Signal_w[15]}}, Signal_w[15:4]};
  ...
  assign Relational_Operator1_1_cast = {20'b0, Abs_out1};
  assign Relational_Operator1_1_cast_1 = {16'b0, {Threshold1_2, 4'b0000}};
  ...
  assign Relational_Operator5_1_cast = {{20{Signal_w[15]}}, Signal_w};
  assign Relational_Operator5_1_cast_1 = {17'b0, {Threshold1_2, 3'b000}};
  ...
  assign Relational_Operator7_1_cast = {{20{Signal_w[15]}}, Signal_w};
  assign Relational_Operator7_1_cast_1 = {17'b0, {Threshold1_2, 3'b000}};
