// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\Soft_Thresholding5.v
// Created: 2024-04-17 20:17:42
// 
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/Soft_Thresholding5
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Soft_Thresholding5
  ...
  input   [15:0] Threshold1;  // ufix16_En24
  ...
  wire signed [15:0] reduced_reg_next [0:3];  // sfix16_En25 [4]
  wire signed [15:0] Signal_w_1;  // sfix16_En25
  wire signed [33:0] Relational_Operator7_1_cast;  // sfix34_En25
  wire signed [33:0] Relational_Operator7_1_cast_1;  // sfix34_En25
  wire Relational_Operator7_relop1;
  wire signed [33:0] Relational_Operator2_1_cast;  // sfix34_En25
  wire signed [33:0] Relational_Operator2_1_cast_1;  // sfix34_En25
  ...
  reg [15:0] Threshold1_1;  // ufix16_En24
  wire signed [16:0] Gain1_cast;  // sfix17_En24
  ...
  wire signed [15:0] Subtract1_sub_cast;  // sfix16_En23
  wire signed [15:0] Subtract1_sub_cast_1;  // sfix16_En23
  wire signed [15:0] Subtract1_out1;  // sfix16_En23
  ...
  wire [15:0] delayMatch_reg_next [0:3];  // ufix16_En26 [4]
  wire [15:0] Abs_out1_1;  // ufix16_En26
  wire [33:0] Relational_Operator1_1_cast;  // ufix34_En26
  wire [33:0] Relational_Operator1_1_cast_1;  // ufix34_En26
  wire Relational_Operator1_relop1;
  reg  Delay5_out1;
  wire signed [33:0] Relational_Operator5_1_cast;  // sfix34_En25
  wire signed [33:0] Relational_Operator5_1_cast_1;  // sfix34_En25
  ...
  wire signed [15:0] delayMatch8_reg_next [0:2];  // sfix16_En23 [3]
  wire signed [15:0] Delay1_out1;  // sfix16_En23
  wire signed [15:0] Delay1_out1_dtc;  // sfix16_En24
  ...
  assign Relational_Operator7_1_cast = {{18{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator7_1_cast_1 = {17'b0, {Threshold1, 1'b0}};
  assign Relational_Operator7_relop1 = Relational_Operator7_1_cast == Relational_Operator7_1_cast_1;


  assign Relational_Operator2_1_cast = {{18{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator2_1_cast_1 = {17'b0, {Threshold1, 1'b0}};
  ...
  assign Gain1_out1 = {{8{Gain1_cast_1[31]}}, Gain1_cast_1[31:24]};
  ...
  assign Relational_Operator1_1_cast = {18'b0, Abs_out1_1};
  assign Relational_Operator1_1_cast_1 = {16'b0, {Threshold1, 2'b00}};
  ...
  assign Relational_Operator5_1_cast = {{18{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator5_1_cast_1 = {17'b0, {Threshold1, 1'b0}};
