// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\alpha1st_Level_Recon.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Recon
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon
  ...
  reg signed [15:0] Add2_out1_1;  // sfix16_En24
  ...
  LoR_Even u_LoR_Even (.clk(clk),
                       ...
                       .Out_LoR_e(LoR_Even_out1)  // sfix16_En25
                       );
  always @(posedge clk)
  ...
  assign Add_add_cast = {HiR_Even_out1[15], HiR_Even_out1[15:1]};
  ...
  LoR_Odd u_LoR_Odd (.clk(clk),
                     ...
                     .Out_LoR_o(LoR_Odd_out1)  // sfix16_En25
                     );
  always @(posedge clk)
  ...
  assign Add1_add_cast = {HiR_Odd_out1[15], HiR_Odd_out1[15:1]};
