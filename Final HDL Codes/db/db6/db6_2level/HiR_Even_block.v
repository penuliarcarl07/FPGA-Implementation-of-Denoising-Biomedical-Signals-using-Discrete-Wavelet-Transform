// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\HiR_Even_block.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Recon1/HiR_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiR_Even_block
  ...
  wire signed [15:0] HiR_0_out1;  // sfix16_En24
  reg signed [15:0] HiR_0_out1_1;  // sfix16_En24
  reg signed [15:0] In_HiR_e_1;  // sfix16_En26
  wire signed [31:0] Multiply_mul_temp;  // sfix32_En50
  wire signed [15:0] Multiply_out1;  // sfix16_En36
  reg signed [15:0] Multiply_out1_1;  // sfix16_En36
  wire [15:0] HiR_2_out1;  // ufix16_En26
  reg [15:0] HiR_2_out1_1;  // ufix16_En26
  reg signed [15:0] Rate_Transition_out1;  // sfix16_En26
  wire signed [16:0] Multiply1_cast;  // sfix17_En26
  wire signed [32:0] Multiply1_mul_temp;  // sfix33_En52
  wire signed [31:0] Multiply1_cast_1;  // sfix32_En52
  wire signed [15:0] Multiply1_out1;  // sfix16_En37
  reg signed [15:0] Multiply1_out1_1;  // sfix16_En37
  wire [15:0] HiR_4_out1;  // ufix16_En21
  reg [15:0] HiR_4_out1_1;  // ufix16_En21
  ...
  wire signed [15:0] HiR_6_out1;  // sfix16_En17
  reg signed [15:0] HiR_6_out1_1;  // sfix16_En17
  ...
  wire [15:0] HiR_8_out1;  // ufix16_En17
  reg [15:0] HiR_8_out1_1;  // ufix16_En17
  ...
  wire signed [15:0] Multiply4_out1;  // sfix16_En27
  reg signed [15:0] Multiply4_out1_1;  // sfix16_En27
  wire [15:0] HiR_10_out1;  // ufix16_En17
  reg [15:0] HiR_10_out1_1;  // ufix16_En17
  ...
  assign HiR_0_out1 = 16'sb1011100101100110;
  ...
  assign HiR_2_out1 = 16'b1001000100110000;
  ...
  assign HiR_4_out1 = 16'b1110000101111000;
  ...
  assign HiR_6_out1 = 16'sb1011110110001111;


  always @(posedge clk)
    begin : HwModeRegister6_process
      if (reset == 1'b1) begin
        HiR_6_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Multiply3_mul_temp = HiR_6_out1_1 * Rate_Transition2_out1;
  ...
  assign HiR_8_out1 = 16'b1010000101101000;
  ...
  assign HiR_10_out1 = 16'b1111110100111111;


  always @(posedge clk)
    begin : HwModeRegister10_process
      if (reset == 1'b1) begin
        HiR_10_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          HiR_10_out1_1 <= HiR_10_out1;
        end
      end
    end
  ...
  assign Add4_add_cast_1 = {Multiply5_out1_1[15], Multiply5_out1_1[15:1]};
  ...
  assign Add3_add_cast = {{3{Multiply3_out1_1[15]}}, Multiply3_out1_1[15:3]};
  ...
  assign Add1_add_cast = {{11{Multiply1_out1_1[15]}}, Multiply1_out1_1[15:11]};
  ...
  assign Add_add_cast = {{10{Multiply_out1_1[15]}}, Multiply_out1_1[15:10]};
