// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\HiD_Even_block.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Decomp6/HiD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Even_block
  ...
  wire signed [31:0] Multiply_mul_temp;  // sfix32_En42
  ...
  reg [15:0] Multiply4_out1_1;  // ufix16_En30
  ...
  wire signed [31:0] Multiply5_mul_temp;  // sfix32_En46
  ...
  wire signed [15:0] Add4_add_cast_1;  // sfix16_En29
  wire signed [15:0] Add4_add_temp;  // sfix16_En29
  wire [15:0] Add4_out1;  // ufix16_En30
  reg [15:0] Delay7_out1;  // ufix16_En30
  wire signed [15:0] Add3_add_cast;  // sfix16_En27
  wire signed [15:0] Add3_add_cast_1;  // sfix16_En27
  wire signed [15:0] Add3_add_temp;  // sfix16_En27
  ...
  wire [15:0] Add2_out1;  // ufix16_En27
  ...
  assign Multiply_out1 = {{11{Multiply_mul_temp[31]}}, Multiply_mul_temp[31:27]};
  ...
  assign Multiply5_mul_temp = HiD_10_out1_1 * Rate_Transition4_out1;
  assign Multiply5_out1 = {{15{Multiply5_mul_temp[31]}}, Multiply5_mul_temp[31]};
  ...
  assign Add4_add_cast_1 = {Multiply5_out1_1[1:0], 14'b00000000000000};
  ...
  assign Add3_add_cast = {Multiply3_out1_1[3:0], 12'b000000000000};
  assign Add3_add_cast_1 = {3'b0, Delay7_out1[15:3]};
  assign Add3_add_temp = Add3_add_cast + Add3_add_cast_1;
  assign Add3_out1 = {{12{Add3_add_temp[15]}}, Add3_add_temp[15:12]};
  ...
  assign Add2_add_cast_1 = {Delay4_out1[4:0], 11'b00000000000};
