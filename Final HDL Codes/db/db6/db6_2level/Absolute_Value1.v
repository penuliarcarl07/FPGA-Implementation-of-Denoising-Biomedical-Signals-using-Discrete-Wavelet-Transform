// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\Absolute_Value1.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/Threshold_Estimator/Absolute_Value1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module Absolute_Value1
  ...
  input   reset;
  input   enb;
  input   signed [15:0] Signal_w4;  // sfix16_En25
  output  [15:0] Out_Abs;  // ufix16_En26


  wire signed [15:0] Constant295_out1;  // sfix16_En4
  wire signed [36:0] Relational_Operator2_1_cast;  // sfix37_En25
  wire signed [36:0] Relational_Operator2_1_cast_1;  // sfix37_En25
  wire Relational_Operator2_relop1;
  reg signed [15:0] Signal_w4_1;  // sfix16_En25
  reg  [0:1] delayMatch_reg;  // ufix1 [2]
  wire [0:1] delayMatch_reg_next;  // ufix1 [2]
  wire Relational_Operator2_out1;
  wire switch_compare_1;
  reg signed [15:0] Signal_w4_2;  // sfix16_En25
  wire [15:0] Signal_w4_dtc;  // ufix16_En26
  wire signed [15:0] kconst;  // sfix16_En15
  reg signed [15:0] kconst_1;  // sfix16_En15
  wire signed [31:0] Gain2_mul_temp;  // sfix32_En40
  wire [15:0] Gain2_out1;  // ufix16_En26
  reg [15:0] Gain2_out1_1;  // ufix16_En26
  wire [15:0] Absolute_Switch_out1;  // ufix16_En26


  assign Constant295_out1 = 16'sb0000000000000000;


  assign Relational_Operator2_1_cast = {{21{Signal_w4[15]}}, Signal_w4};
  assign Relational_Operator2_1_cast_1 = {Constant295_out1, 21'b000000000000000000000};
