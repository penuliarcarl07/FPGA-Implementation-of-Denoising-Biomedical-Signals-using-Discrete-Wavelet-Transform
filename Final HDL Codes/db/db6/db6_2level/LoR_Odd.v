// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\LoR_Odd.v
...
// 
// Module: LoR_Odd
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Recon/LoR_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoR_Odd
  ...
  output  signed [15:0] Out_LoR_o;  // sfix16_En25
  ...
  reg signed [15:0] Multiply2_out1_1;  // sfix16_En27
  ...
  wire signed [15:0] Multiply4_out1;  // sfix16_En35
  reg signed [15:0] Multiply4_out1_1;  // sfix16_En35
  ...
  wire signed [15:0] Multiply5_out1;  // sfix16_En34
  reg signed [15:0] delayMatch_reg [0:1];  // sfix16 [2]
  wire signed [15:0] delayMatch_reg_next [0:1];  // sfix16_En34 [2]
  wire signed [15:0] Multiply5_out1_1;  // sfix16_En34
  wire signed [15:0] Add4_add_cast;  // sfix16_En34
  wire signed [15:0] Add4_add_temp;  // sfix16_En34
  wire signed [15:0] Add4_out1;  // sfix16_En35
  reg signed [15:0] Delay7_out1;  // sfix16_En35
  ...
  assign Multiply5_out1 = Multiply5_mul_temp[29:14];
  ...
  assign Add3_add_cast = {{6{Delay7_out1[15]}}, Delay7_out1[15:6]};
  ...
  assign Add1_add_cast = {Delay2_out1[15], Delay2_out1[15:1]};
  ...
  assign Add_add_cast = {Delay3_out1[15], Delay3_out1[15:1]};
