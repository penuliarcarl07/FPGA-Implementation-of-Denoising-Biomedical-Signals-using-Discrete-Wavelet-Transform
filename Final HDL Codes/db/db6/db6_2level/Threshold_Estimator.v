// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\Threshold_Estimator.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/Threshold_Estimator
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Threshold_Estimator
  ...
  output  [15:0] Threshold;  // ufix16_En24


  wire [15:0] Absolute_Value1_out1;  // ufix16_En26
  wire [15:0] Median2_out1;  // ufix16_En26
  reg [15:0] Median2_out1_1;  // ufix16_En26
  ...
  Absolute_Value1 u_Absolute_Value1 (.clk(clk),
                                     .reset(reset),
                                     .enb(enb),
                                     .Signal_w4(Signal_w),  // sfix16_En25
                                     .Out_Abs(Absolute_Value1_out1)  // ufix16_En26
                                     );
  Median2 u_Median2 (.clk(clk),
                     .reset(reset),
                     .enb(enb),
                     .Signal_w3(Absolute_Value1_out1),  // ufix16_En26
                     .Median(Median2_out1)  // ufix16_En26
                     );
  always @(posedge clk)
