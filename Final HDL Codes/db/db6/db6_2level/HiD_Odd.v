// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\HiD_Odd.v
...
// 
// Module: HiD_Odd
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Decomp5/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd
  ...
  wire [31:0] Multiply3_mul_temp;  // ufix32_En45
  wire [15:0] Multiply3_out1;  // ufix16_En29
  reg [15:0] Multiply3_out1_1;  // ufix16_En29
  wire [15:0] HiD_9_out1;  // ufix16_En26
  reg [15:0] HiD_9_out1_1;  // ufix16_En26
  reg [15:0] Rate_Transition3_out1;  // ufix16_En24
  wire [31:0] Multiply4_mul_temp;  // ufix32_En50
  ...
  wire signed [32:0] Multiply5_mul_temp;  // sfix33_En48
  wire signed [31:0] Multiply5_cast_1;  // sfix32_En48
  ...
  wire signed [15:0] Add3_add_cast_1;  // sfix16_En28
  wire signed [15:0] Add3_add_temp;  // sfix16_En28
  wire [15:0] Add3_out1;  // ufix16_En29
  reg [15:0] Delay4_out1;  // ufix16_En29
  ...
  assign Multiply2_out1 = {{10{Multiply2_cast_1[31]}}, Multiply2_cast_1[31:26]};
  ...
  assign Multiply3_mul_temp = HiD_7_out1_1 * Rate_Transition2_out1;
  ...
  assign Multiply5_mul_temp = HiD_11_out1_1 * Multiply5_cast;
  assign Multiply5_cast_1 = Multiply5_mul_temp[31:0];
  assign Multiply5_out1 = {16{Multiply5_cast_1[31]}};
  ...
  assign Add3_add_cast_1 = {{6{Delay7_out1[15]}}, Delay7_out1[15:6]};
  ...
  assign Add2_add_cast_1 = {3'b0, Delay4_out1[15:3]};
