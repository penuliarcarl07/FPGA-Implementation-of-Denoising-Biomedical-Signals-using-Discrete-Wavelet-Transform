// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db6_2level_final_hdl\LoD_Odd_block.v
...
// Source Path: db6_2level_final_hdl/DWT_db6_2level/1st_Level_Decomp6/LoD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Odd_block
  ...
  reg [15:0] Multiply2_out1_1;  // ufix16_En28
  ...
  assign Multiply1_mul_temp = LoD_3_out1_1 * Rate_Transition4_out1;
  assign Multiply1_out1 = {{12{Multiply1_mul_temp[31]}}, Multiply1_mul_temp[31:28]};
  ...
  assign Multiply2_cast = {1'b0, LoD_5_out1_1};
  assign Multiply2_mul_temp = Multiply2_cast * Rate_Transition3_out1;
  ...
  assign Multiply3_mul_temp = LoD_7_out1_1 * Rate_Transition2_out1;
  ...
  assign Multiply4_cast = {1'b0, LoD_9_out1_1};
  ...
  assign Multiply5_cast = {1'b0, LoD_11_out1_1};
  assign Multiply5_mul_temp = Multiply5_cast * Rate_Transition_out1;
  ...
  assign Add_add_cast = {8'b0, Multiply_out1_1[15:8]};
