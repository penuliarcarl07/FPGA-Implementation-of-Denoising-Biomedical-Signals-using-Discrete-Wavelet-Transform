-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\HiD_Odd.vhd
...
-- 
-- Module: HiD_Odd
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/1st_Level_Decomp/HiD_Odd
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY HiD_Odd IS
  PORT( clk                               :   IN    std_logic;
        reset                             :   IN    std_logic;
        enb                               :   IN    std_logic;
        In_HiD_o                          :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16_En23
        Out_HiD_o                         :   OUT   std_logic_vector(15 DOWNTO 0)  -- sfix16_En23
        );
END HiD_Odd;


ARCHITECTURE rtl OF HiD_Odd IS

  -- Signals
  SIGNAL HiD_1_out1                       : unsigned(15 DOWNTO 0);  -- ufix16_En16
  SIGNAL HiD_1_out1_1                     : unsigned(15 DOWNTO 0);  -- ufix16_En16
  SIGNAL In_HiD_o_unsigned                : unsigned(15 DOWNTO 0);  -- ufix16_En23
  SIGNAL In_HiD_o_1                       : unsigned(15 DOWNTO 0);  -- ufix16_En23
  SIGNAL Multiply_mul_temp                : unsigned(31 DOWNTO 0);  -- ufix32_En39
  ...
  SIGNAL Multiply2_mul_temp               : unsigned(31 DOWNTO 0);  -- ufix32_En43
  ...
  SIGNAL Add1_out1                        : signed(15 DOWNTO 0);  -- sfix16_En25
  SIGNAL Delay3_out1                      : signed(15 DOWNTO 0);  -- sfix16_En25
...
BEGIN
  ...
  In_HiD_o_unsigned <= unsigned(In_HiD_o);

  reduced_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        In_HiD_o_1 <= to_unsigned(16#0000#, 16);
      ELSIF enb = '1' THEN
        In_HiD_o_1 <= In_HiD_o_unsigned;
      END IF;
    END IF;
  END PROCESS reduced_process;


  Multiply_mul_temp <= HiD_1_out1_1 * In_HiD_o_1;
  ...
  Multiply1_mul_temp <= HiD_3_out1_1 * Multiply1_cast;
  ...
  Multiply2_mul_temp <= HiD_5_out1_1 * Rate_Transition1_out1;
  ...
  Add_add_cast_1 <= resize(Delay3_out1(15 DOWNTO 2), 16);
