-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\LoD_Even_block.vhd
...
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/2nd_Level_Decomp/LoD_Even
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LoD_Even_block IS

  -- Signals
  SIGNAL LoD_0_out1                       : unsigned(15 DOWNTO 0);  -- ufix16_En20
  SIGNAL LoD_0_out1_1                     : unsigned(15 DOWNTO 0);  -- ufix16_En20
  SIGNAL In_LoD_e_signed                  : signed(15 DOWNTO 0);  -- sfix16_En23
  SIGNAL In_LoD_e_1                       : signed(15 DOWNTO 0);  -- sfix16_En23
  SIGNAL Multiply_cast                    : signed(16 DOWNTO 0);  -- sfix17_En20
  SIGNAL Multiply_mul_temp                : signed(32 DOWNTO 0);  -- sfix33_En43
  SIGNAL Multiply_cast_1                  : signed(31 DOWNTO 0);  -- sfix32_En43
  ...
  SIGNAL Multiply2_mul_temp               : signed(32 DOWNTO 0);  -- sfix33_En39
  SIGNAL Multiply2_cast_1                 : signed(31 DOWNTO 0);  -- sfix32_En39
...
BEGIN
  ...
  In_LoD_e_signed <= signed(In_LoD_e);

  reduced_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        In_LoD_e_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        In_LoD_e_1 <= In_LoD_e_signed;
      END IF;
    END IF;
  END PROCESS reduced_process;


  Multiply_cast <= signed(resize(LoD_0_out1_1, 17));
  Multiply_mul_temp <= Multiply_cast * In_LoD_e_1;
  ...
  Multiply1_mul_temp <= LoD_2_out1_1 * Rate_Transition2_out1;
  ...
  Multiply2_cast <= signed(resize(LoD_4_out1_1, 17));
