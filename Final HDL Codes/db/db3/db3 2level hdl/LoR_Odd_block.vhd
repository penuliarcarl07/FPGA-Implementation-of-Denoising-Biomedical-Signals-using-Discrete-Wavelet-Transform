-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\LoR_Odd_block.vhd
...
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/2nd_Level_Recon/LoR_Odd
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LoR_Odd_block IS
  ...
  SIGNAL Multiply1_out1                   : signed(15 DOWNTO 0);  -- sfix16_En25
  SIGNAL Multiply1_out1_1                 : signed(15 DOWNTO 0);  -- sfix16_En25
...
BEGIN
  ...
  Multiply2_out1 <= Multiply2_cast_1(31 DOWNTO 16);
  ...
  Add1_add_temp <= Multiply1_out1_1 + Add1_add_cast;
