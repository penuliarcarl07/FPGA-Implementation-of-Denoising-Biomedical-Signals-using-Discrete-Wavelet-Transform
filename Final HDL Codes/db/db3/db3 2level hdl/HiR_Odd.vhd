-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\HiR_Odd.vhd
...
-- 
-- Module: HiR_Odd
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/1st_Level_Recon/HiR_Odd
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF HiR_Odd IS
  ...
  SIGNAL Multiply1_out1                   : signed(15 DOWNTO 0);  -- sfix16_En28
  SIGNAL Multiply1_out1_1                 : signed(15 DOWNTO 0);  -- sfix16_En28
  ...
  SIGNAL Add1_out1                        : signed(15 DOWNTO 0);  -- sfix16_En28
  SIGNAL Delay3_out1                      : signed(15 DOWNTO 0);  -- sfix16_En28
  SIGNAL Add_add_cast                     : signed(15 DOWNTO 0);  -- sfix16_En28
  SIGNAL Add_out1                         : signed(15 DOWNTO 0);  -- sfix16_En28
...
BEGIN
  ...
  Add1_out1 <= Multiply1_out1_1 + Multiply2_out1_1;
  ...
  Add_add_cast <= resize(Multiply_out1_1(15 DOWNTO 2), 16);
