-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\alpha1st_Level_Decomp.vhd
...
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/1st_Level_Decomp
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF alpha1st_Level_Decomp IS
  ...
  FOR ALL : HiD_Even
    USE ENTITY work.HiD_Even(rtl);

  FOR ALL : HiD_Odd
    USE ENTITY work.HiD_Odd(rtl);

  FOR ALL : LoD_Even
    USE ENTITY work.LoD_Even(rtl);

  FOR ALL : LoD_Odd
    USE ENTITY work.LoD_Odd(rtl);
  ...
  SIGNAL Add_out1                         : signed(15 DOWNTO 0);  -- sfix16_En24
  SIGNAL Add_out1_1                       : signed(15 DOWNTO 0);  -- sfix16_En24
  SIGNAL HiD_cast                         : signed(16 DOWNTO 0);  -- sfix17_En16
  SIGNAL HiD_mul_temp                     : signed(32 DOWNTO 0);  -- sfix33_En40
  SIGNAL HiD_cast_1                       : signed(31 DOWNTO 0);  -- sfix32_En40
  SIGNAL HiD_out1                         : signed(15 DOWNTO 0);  -- sfix16_En24
  SIGNAL HiD_out1_1                       : signed(15 DOWNTO 0);  -- sfix16_En24
...
BEGIN
  ...
  Add_out1 <= Add_add_temp(14 DOWNTO 0) & '0';
