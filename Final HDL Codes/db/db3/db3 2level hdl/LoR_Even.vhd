-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\LoR_Even.vhd
...
-- 
-- Module: LoR_Even
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/1st_Level_Recon/LoR_Even
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LoR_Even IS
  ...
  SIGNAL Multiply_out1                    : signed(15 DOWNTO 0);  -- sfix16_En25
  SIGNAL Multiply_out1_1                  : signed(15 DOWNTO 0);  -- sfix16_En25
...
BEGIN
  ...
  Add1_add_cast <= resize(Multiply2_out1_1(15 DOWNTO 3), 16);
