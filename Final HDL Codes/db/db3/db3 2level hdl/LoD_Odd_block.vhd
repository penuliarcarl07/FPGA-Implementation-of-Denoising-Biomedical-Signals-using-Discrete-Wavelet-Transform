-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\db3_2_Level_fixdt\LoD_Odd_block.vhd
...
-- Source Path: db3_2_Level_fixdt/DWT_db3_2_Level/2nd_Level_Decomp/LoD_Odd
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF LoD_Odd_block IS

  -- Signals
  SIGNAL LoD_1_out1                       : signed(15 DOWNTO 0);  -- sfix16_En18
  SIGNAL LoD_1_out1_1                     : signed(15 DOWNTO 0);  -- sfix16_En18
  SIGNAL In_LoD_o_signed                  : signed(15 DOWNTO 0);  -- sfix16_En23
  SIGNAL In_LoD_o_1                       : signed(15 DOWNTO 0);  -- sfix16_En23
  SIGNAL Multiply_mul_temp                : signed(31 DOWNTO 0);  -- sfix32_En41
  ...
  SIGNAL Multiply1_out1                   : unsigned(15 DOWNTO 0);  -- ufix16_En25
  SIGNAL Multiply1_out1_1                 : unsigned(15 DOWNTO 0);  -- ufix16_En25
  ...
  SIGNAL Multiply2_cast                   : signed(16 DOWNTO 0);  -- sfix17_En17
  SIGNAL Multiply2_mul_temp               : signed(32 DOWNTO 0);  -- sfix33_En40
  SIGNAL Multiply2_cast_1                 : signed(31 DOWNTO 0);  -- sfix32_En40
  ...
  SIGNAL Add1_add_cast_1                  : unsigned(15 DOWNTO 0);  -- ufix16_En24
...
BEGIN
  ...
  In_LoD_o_signed <= signed(In_LoD_o);

  reduced_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        In_LoD_o_1 <= to_signed(16#0000#, 16);
      ELSIF enb = '1' THEN
        In_LoD_o_1 <= In_LoD_o_signed;
      END IF;
    END IF;
  END PROCESS reduced_process;


  Multiply_mul_temp <= LoD_1_out1_1 * In_LoD_o_1;
  Multiply_out1 <= resize(Multiply_mul_temp(31 DOWNTO 26), 16);
  ...
  Multiply1_cast <= signed(resize(LoD_3_out1_1, 17));
  Multiply1_mul_temp <= Multiply1_cast * Rate_Transition2_out1;
  Multiply1_cast_1 <= Multiply1_mul_temp(31 DOWNTO 0);
  Multiply1_out1 <= unsigned(Multiply1_cast_1(30 DOWNTO 15));
  ...
  Multiply2_cast <= signed(resize(LoD_5_out1_1, 17));
  ...
  Add1_add_cast <= resize(Multiply1_out1_1(15 DOWNTO 1), 16);
  Add1_add_cast_1 <= resize(Multiply2_out1_1(15 DOWNTO 1), 16);
