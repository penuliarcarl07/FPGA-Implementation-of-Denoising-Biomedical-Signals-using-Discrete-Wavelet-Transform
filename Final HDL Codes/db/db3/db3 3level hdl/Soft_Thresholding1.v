// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db3_3_Level_fixdt\Soft_Thresholding1.v
...
// Source Path: db3_3_Level_fixdt/DWT_db3_3_Level/Soft_Thresholding1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Soft_Thresholding1
  ...
  output  signed [15:0] New_Threshold;  // sfix16_En26


  wire signed [15:0] kconst;  // sfix16_En17
  reg signed [15:0] kconst_1;  // sfix16_En17
  reg signed [15:0] reduced_reg [0:3];  // sfix16 [4]
  wire signed [15:0] reduced_reg_next [0:3];  // sfix16_En26 [4]
  wire signed [15:0] Signal_w_1;  // sfix16_En26
  wire signed [35:0] Relational_Operator7_1_cast;  // sfix36_En26
  wire signed [35:0] Relational_Operator7_1_cast_1;  // sfix36_En26
  wire Relational_Operator7_relop1;
  wire signed [35:0] Relational_Operator2_1_cast;  // sfix36_En26
  wire signed [35:0] Relational_Operator2_1_cast_1;  // sfix36_En26
  ...
  wire signed [15:0] reduced_reg_next_1 [0:1];  // sfix16_En26 [2]
  wire signed [15:0] Signal_w_2;  // sfix16_En26
  ...
  wire signed [26:0] Relational_Operator3_1_cast;  // sfix27_En26
  wire signed [26:0] Relational_Operator3_1_cast_1;  // sfix27_En26
  ...
  wire signed [16:0] Abs_y;  // sfix17_En26
  wire signed [16:0] Abs_cast;  // sfix17_En26
  wire [15:0] Abs_out1;  // ufix16_En27
  reg [15:0] delayMatch_reg [0:3];  // ufix16 [4]
  wire [15:0] delayMatch_reg_next [0:3];  // ufix16_En27 [4]
  wire [15:0] Abs_out1_1;  // ufix16_En27
  wire [35:0] Relational_Operator1_1_cast;  // ufix36_En27
  wire [35:0] Relational_Operator1_1_cast_1;  // ufix36_En27
  wire Relational_Operator1_relop1;
  reg  Delay5_out1;
  wire signed [35:0] Relational_Operator5_1_cast;  // sfix36_En26
  wire signed [35:0] Relational_Operator5_1_cast_1;  // sfix36_En26
  ...
  wire signed [31:0] Gain_mul_temp;  // sfix32_En41
  wire signed [15:0] Gain_out1;  // sfix16_En26
  reg signed [15:0] Gain_out1_1;  // sfix16_En26


  assign kconst = 16'sb0011001111011011;
  ...
  assign Relational_Operator7_1_cast = {{20{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator7_1_cast_1 = {19'b0, {Threshold1, 1'b0}};
  assign Relational_Operator7_relop1 = Relational_Operator7_1_cast == Relational_Operator7_1_cast_1;


  assign Relational_Operator2_1_cast = {{20{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator2_1_cast_1 = {19'b0, {Threshold1, 1'b0}};
  ...
  assign Relational_Operator3_1_cast = {{11{Signal_w_2[15]}}, Signal_w_2};
  assign Relational_Operator3_1_cast_1 = {Gain1_out1_1, 11'b00000000000};
  ...
  assign Add1_add_cast = {{2{Signal_w_1[15]}}, Signal_w_1[15:2]};
  ...
  assign Relational_Operator1_1_cast = {20'b0, Abs_out1_1};
  assign Relational_Operator1_1_cast_1 = {18'b0, {Threshold1, 2'b00}};
  ...
  assign Relational_Operator5_1_cast = {{20{Signal_w_1[15]}}, Signal_w_1};
  assign Relational_Operator5_1_cast_1 = {19'b0, {Threshold1, 1'b0}};
  ...
  assign Gain_mul_temp = kconst_1 * Threshold_Switch2_out1_1;
  assign Gain_out1 = Gain_mul_temp[30:15];
