// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db3_3_Level_fixdt\HiR_Even_block1.v
...
// Source Path: db3_3_Level_fixdt/DWT_db3_3_Level/3rd_Level_Recon/HiR_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiR_Even_block1
  ...
  wire [15:0] HiR_0_out1;  // ufix16_En20
  reg [15:0] HiR_0_out1_1;  // ufix16_En20
  reg signed [15:0] In_HiR_e_1;  // sfix16_En26
  wire signed [16:0] Multiply_cast;  // sfix17_En20
  wire signed [32:0] Multiply_mul_temp;  // sfix33_En46
  wire signed [31:0] Multiply_cast_1;  // sfix32_En46
  wire signed [15:0] Multiply_out1;  // sfix16_En31
  reg signed [15:0] Multiply_out1_1;  // sfix16_En31
  wire signed [15:0] HiR_2_out1;  // sfix16_En17
  reg signed [15:0] HiR_2_out1_1;  // sfix16_En17
  ...
  assign HiR_0_out1 = 16'b1001000001001001;
  ...
  assign HiR_2_out1 = 16'sb1011101011100000;
  ...
  assign HiR_4_out1 = 16'b1100111010010000;
  ...
  assign Add1_out1 = Add1_add_cast + Multiply2_out1_1;
