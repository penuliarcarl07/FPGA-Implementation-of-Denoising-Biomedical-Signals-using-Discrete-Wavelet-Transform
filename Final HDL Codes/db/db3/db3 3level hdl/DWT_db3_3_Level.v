// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\db3_3_Level_fixdt\DWT_db3_3_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_db3_3_Level
// Source Path: db3_3_Level_fixdt/DWT_db3_3_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_db3_3_Level
  ...
  wire signed [15:0] Soft_Thresholding1_out1;  // sfix16_En26
  reg signed [15:0] alpha2nd_Level_Decomp_out2_1;  // sfix16_En23
  reg signed [15:0] reduced_reg_1 [0:25];  // sfix16 [26]
  wire signed [15:0] reduced_reg_next_1 [0:25];  // sfix16_En23 [26]
  wire signed [15:0] alpha2nd_Level_Decomp_out2_2;  // sfix16_En23
  ...
  wire signed [15:0] alpha3rd_Level_Decomp_out2;  // sfix16_En23
  wire signed [15:0] Soft_Thresholding2_out1;  // sfix16_En26
  wire signed [15:0] alpha1st_Level_Recon_out1;  // sfix16_En23
  wire signed [15:0] alpha2nd_Level_Recon_out1;  // sfix16_En23
  wire signed [15:0] alpha3rd_Level_Recon_out1;  // sfix16_En22


  DWT_db3_3_Level_tc u_DWT_db3_3_Level_tc (.clk(clk),
                                           .reset(reset),
  ...
  always @(posedge clk)
    begin : reduced_2_process
      if (reset == 1'b1) begin
        alpha2nd_Level_Decomp_out2_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  alpha3rd_Level_Decomp u_3rd_Level_Decomp (.clk(clk),
                                            ...
                                            .Out_LoD(alpha3rd_Level_Decomp_out2)  // sfix16_En23
                                            );
  Soft_Thresholding2 u_Soft_Thresholding2 (.clk(clk),
                                           ...
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En25
                                           .New_Threshold(Soft_Thresholding2_out1)  // sfix16_En26
                                           );
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          .reset(reset),
                                          .enb(enb),
                                          .In_HiD(Soft_Thresholding2_out1),  // sfix16_En26
                                          .In_LoD(alpha3rd_Level_Decomp_out2),  // sfix16_En23
  ...
  alpha3rd_Level_Recon u_3rd_Level_Recon (.clk(clk),
                                          ...
                                          .Out(alpha3rd_Level_Recon_out1)  // sfix16_En22
                                          );
  assign Out1 = alpha3rd_Level_Recon_out1;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_db3_3_Level
