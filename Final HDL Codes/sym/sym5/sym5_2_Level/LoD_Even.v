// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\LoD_Even.v
...
// 
// Module: LoD_Even
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Decomp/LoD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Even
  ...
  wire [15:0] LoD_0_out1;  // ufix16_En21
  reg [15:0] LoD_0_out1_1;  // ufix16_En21
  ...
  wire signed [15:0] LoD_2_out1;  // sfix16_En19
  reg signed [15:0] LoD_2_out1_1;  // sfix16_En19
  ...
  wire [15:0] LoD_6_out1;  // ufix16_En21
  reg [15:0] LoD_6_out1_1;  // ufix16_En21
  ...
  wire signed [15:0] LoD_8_out1;  // sfix16_En20
  reg signed [15:0] LoD_8_out1_1;  // sfix16_En20
  ...
  wire signed [15:0] Add2_add_cast;  // sfix16_En29
  wire signed [15:0] Add2_add_cast_1;  // sfix16_En29
  ...
  assign LoD_0_out1 = 16'b1101111111101010;
  ...
  assign Multiply_mul_temp = LoD_0_out1_1 * In_HiD_e_1;
  ...
  assign LoD_2_out1 = 16'sb1010111111011010;
  ...
  assign Multiply1_mul_temp = LoD_2_out1_1 * Multiply1_cast;
  ...
  assign LoD_4_out1 = 16'b1011100100110001;
  ...
  assign LoD_6_out1 = 16'b1000100000000001;
  ...
  assign Multiply3_mul_temp = LoD_6_out1_1 * Rate_Transition4_out1;
  ...
  assign LoD_8_out1 = 16'sb1010100110010001;


  always @(posedge clk)
    begin : HwModeRegister8_process
      if (reset == 1'b1) begin
        LoD_8_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Multiply4_mul_temp = LoD_8_out1_1 * Multiply4_cast;
  ...
  assign Add2_add_cast = {1'b0, Multiply3_out1_1[15:1]};
  assign Add2_add_cast_1 = {Multiply4_out1_1[1:0], 14'b00000000000000};
  ...
  assign Add4_add_cast_1 = {{6{Delay9_out1[15]}}, Delay9_out1[15:6]};
  ...
  assign Add_add_cast = {6'b0, Multiply_out1_1[15:6]};
