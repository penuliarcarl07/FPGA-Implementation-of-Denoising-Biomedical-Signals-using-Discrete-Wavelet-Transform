// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\HiD_Even_block.v
...
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Decomp1/HiD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Even_block
  ...
  wire signed [31:0] Multiply2_mul_temp;  // sfix32_En38
  ...
  assign Multiply1_cast = {1'b0, HiD_2_out1_1};
  ...
  assign Multiply2_out1 = {{7{Multiply2_mul_temp[31]}}, Multiply2_mul_temp[31:23]};
  ...
  assign Multiply3_mul_temp = HiD_6_out1_1 * Rate_Transition4_out1;
  ...
  assign Multiply4_mul_temp = HiD_8_out1_1 * Rate_Transition2_out1;
  ...
  assign Add1_add_cast_1 = {Delay2_out1[6:0], 9'b000000000};
