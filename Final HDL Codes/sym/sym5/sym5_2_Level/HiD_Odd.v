// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\HiD_Odd.v
...
// 
// Module: HiD_Odd
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Decomp/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd
  ...
  wire signed [15:0] HiD_1_out1;  // sfix16_En20
  reg signed [15:0] HiD_1_out1_1;  // sfix16_En20
  ...
  wire [15:0] HiD_3_out1;  // ufix16_En21
  reg [15:0] HiD_3_out1_1;  // ufix16_En21
  reg [15:0] Rate_Transition_out1;  // ufix16_En24
  wire [31:0] Multiply1_mul_temp;  // ufix32_En45
  wire [15:0] Multiply1_out1;  // ufix16_En30
  reg [15:0] Multiply1_out1_1;  // ufix16_En30
  wire [15:0] HiD_5_out1;  // ufix16_En16
  reg [15:0] HiD_5_out1_1;  // ufix16_En16
  ...
  wire signed [15:0] HiD_7_out1;  // sfix16_En19
  reg signed [15:0] HiD_7_out1_1;  // sfix16_En19
  ...
  wire [15:0] HiD_9_out1;  // ufix16_En21
  reg [15:0] HiD_9_out1_1;  // ufix16_En21
  ...
  assign HiD_1_out1 = 16'sb1010100110010001;
  ...
  assign Multiply_mul_temp = HiD_1_out1_1 * Multiply_cast;
  ...
  assign HiD_3_out1 = 16'b1000100000000001;
  ...
  assign HiD_5_out1 = 16'b1011100100110001;
  ...
  assign HiD_7_out1 = 16'sb1010111111011010;
  ...
  assign Multiply3_out1 = {{12{Multiply3_cast_1[31]}}, Multiply3_cast_1[31:28]};
  ...
  assign HiD_9_out1 = 16'b1101111111101010;
  ...
  assign Multiply4_mul_temp = HiD_9_out1_1 * Rate_Transition2_out1;
  ...
  assign Add2_add_cast_1 = {1'b0, Multiply4_out1_1[15:1]};
