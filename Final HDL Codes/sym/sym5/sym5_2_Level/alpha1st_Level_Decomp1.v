// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\alpha1st_Level_Decomp1.v
...
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Decomp1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Decomp1
  ...
  output  [15:0] Out_LoD;  // ufix16_En25
  ...
  reg signed [15:0] Add_out1_1;  // sfix16_En25
  ...
  wire [15:0] Gain1_out1;  // ufix16_En25
  reg [15:0] Gain1_out1_1;  // ufix16_En25


  assign kconst = 16'b1000011111001001;
  ...
  HiD_Odd_block u_HiD_Odd (.clk(clk),
                           ...
                           .Out_HiD_e(HiD_Odd_out1)  // sfix16_En24
                           );
  ...
  assign kconst_2 = 16'b1000011111001001;
  ...
  LoD_Even_block u_LoD_Even (.clk(clk),
                             ...
                             .enb(enb),
                             .In_HiD_e(In_E),  // sfix16_En23
                             .Out_HiD_e(LoD_Even_out1)  // sfix16_En24
                             );
  LoD_Odd_block u_LoD_Odd (.clk(clk),
                           .reset(reset),
                           .enb(enb),
                           .In_HiD_e(In_O),  // sfix16_En23
                           .Out_HiD_e(LoD_Odd_out1)  // ufix16_En25
                           );
