// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\LoR_Even.v
...
// 
// Module: LoR_Even
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Recon/LoR_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoR_Even
  ...
  wire [31:0] Multiply_mul_temp;  // ufix32_En46
  wire [15:0] Multiply_out1;  // ufix16_En30
  reg [15:0] Multiply_out1_1;  // ufix16_En30
  wire signed [15:0] LoR_2_out1;  // sfix16_En17
  reg signed [15:0] LoR_2_out1_1;  // sfix16_En17
  reg [15:0] Rate_Transition_out1;  // ufix16_En25
  wire signed [16:0] Multiply1_cast;  // sfix17_En25
  wire signed [32:0] Multiply1_mul_temp;  // sfix33_En42
  wire signed [31:0] Multiply1_cast_1;  // sfix32_En42
  ...
  wire [31:0] Multiply3_mul_temp;  // ufix32_En43
  ...
  wire [15:0] Add2_add_cast;  // ufix16_En27
  wire [15:0] Add2_out1;  // ufix16_En27
  reg [15:0] Delay9_out1;  // ufix16_En27
  ...
  assign Multiply_mul_temp = LoR_0_out1_1 * In_HiD_e_1;
  ...
  assign Multiply1_mul_temp = LoR_2_out1_1 * Multiply1_cast;
  assign Multiply1_cast_1 = Multiply1_mul_temp[31:0];
  assign Multiply1_out1 = {{11{Multiply1_cast_1[31]}}, Multiply1_cast_1[31:27]};
  ...
  assign Multiply3_mul_temp = LoR_6_out1_1 * Rate_Transition4_out1;
  ...
  assign Multiply4_mul_temp = LoR_8_out1_1 * Rate_Transition2_out1;
  ...
  assign Add2_add_cast = {3'b0, Multiply4_out1_1[15:3]};
  ...
  assign Add4_add_cast = {2'b0, Delay9_out1[15:2]};
