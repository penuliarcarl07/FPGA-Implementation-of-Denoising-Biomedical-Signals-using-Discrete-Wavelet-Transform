// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\sym5_2_Level\LoD_Even_block.v
...
// Source Path: sym5_2_Level/DWT_sym5_2_Level/1st_Level_Decomp1/LoD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Even_block
  ...
  wire signed [31:0] Multiply1_mul_temp;  // sfix32_En42
  ...
  wire signed [15:0] Add2_add_temp;  // sfix16_En29
  wire signed [15:0] Add2_out1;  // sfix16_En31
  reg signed [15:0] Delay9_out1;  // sfix16_En31
  ...
  assign Multiply1_out1 = {{11{Multiply1_mul_temp[31]}}, Multiply1_mul_temp[31:27]};
  ...
  assign Multiply4_mul_temp = LoD_8_out1_1 * Rate_Transition2_out1;
  ...
  assign Add2_out1 = {Add2_add_temp[13:0], 2'b00};
  ...
  assign Add4_add_cast_1 = {{7{Delay9_out1[15]}}, Delay9_out1[15:7]};
