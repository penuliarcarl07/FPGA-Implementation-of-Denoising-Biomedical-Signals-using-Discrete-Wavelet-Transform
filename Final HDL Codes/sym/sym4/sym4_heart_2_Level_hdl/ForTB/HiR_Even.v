// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\HiR_Even.v
...
// 
// Module: HiR_Even
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Recon1/HiR_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiR_Even
  ...
  output  signed [15:0] Out_HiR_e;  // sfix16_En29


  wire signed [15:0] HiR_0_out1;  // sfix16_En18
  reg signed [15:0] HiR_0_out1_1;  // sfix16_En18
  reg signed [15:0] In_HiR_e_1;  // sfix16_En28
  wire signed [31:0] Multiply4_mul_temp;  // sfix32_En46
  wire signed [15:0] Multiply4_out1;  // sfix16_En32
  reg signed [15:0] Multiply4_out1_1;  // sfix16_En32
  wire [15:0] HiR_2_out1;  // ufix16_En17
  reg [15:0] HiR_2_out1_1;  // ufix16_En17
  ...
  wire [15:0] HiR_4_out1;  // ufix16_En17
  reg [15:0] HiR_4_out1_1;  // ufix16_En17
  ...
  reg signed [15:0] Multiply2_out1_1;  // sfix16_En30
  wire signed [15:0] HiR_6_out1;  // sfix16_En21
  reg signed [15:0] HiR_6_out1_1;  // sfix16_En21
  reg signed [15:0] Rate_Transition2_out1;  // sfix16_En28
  wire signed [31:0] Multiply3_mul_temp;  // sfix32_En49
  wire signed [15:0] Multiply3_out1;  // sfix16_En34
  reg signed [15:0] delayMatch_reg [0:1];  // sfix16 [2]
  wire signed [15:0] delayMatch_reg_next [0:1];  // sfix16_En34 [2]
  wire signed [15:0] Multiply3_out1_1;  // sfix16_En34
  wire signed [15:0] Add2_add_cast;  // sfix16_En30
  wire signed [15:0] Add2_out1;  // sfix16_En30
  reg signed [15:0] Delay3_out1;  // sfix16_En30
  ...
  assign HiR_0_out1 = 16'sb1011001001101010;
  ...
  assign Multiply4_mul_temp = HiR_0_out1_1 * In_HiR_e_1;
  ...
  assign HiR_2_out1 = 16'b1111111011001000;
  ...
  assign HiR_4_out1 = 16'b1001100010000001;
  ...
  assign HiR_6_out1 = 16'sb1001100011000000;
  ...
  assign Add2_add_cast = {{4{Multiply3_out1_1[15]}}, Multiply3_out1_1[15:4]};
  ...
  assign Add1_add_cast = {Delay3_out1[15], Delay3_out1[15:1]};
  ...
  assign Add3_add_cast = {{3{Multiply4_out1_1[15]}}, Multiply4_out1_1[15:3]};
  assign Add3_out1 = Add3_add_cast + Delay7_out1;


  assign Out_HiR_e = Add3_out1;
