// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\DWT_sym4_2_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_sym4_2_Level
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_sym4_2_Level
  ...
  wire signed [15:0] Denoised_Heart_Sound_Sym_4_Level_2;  // sfix16_En22


  DWT_sym4_2_Level_tc u_DWT_sym4_2_Level_tc (.clk(clk),
                                             .reset(reset),
  ...
  alpha1st_Level_Decomp u_1st_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(RT_out1),  // ufix16_En23
                                            .In_O(RT1_out1),  // ufix16_En23
  ...
  alpha1st_Level_Recon1 u_1st_Level_Recon1 (.clk(clk),
                                            ...
                                            .In_LoD(alpha1st_Level_Decomp1_out2),  // sfix16_En23
  ...
  alpha1st_Level_Recon2 u_1st_Level_Recon2 (.clk(clk),
                                            ...
                                            .Out1(Denoised_Heart_Sound_Sym_4_Level_2)  // sfix16_En22
                                            );
  assign Out1 = Denoised_Heart_Sound_Sym_4_Level_2;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_sym4_2_Level
