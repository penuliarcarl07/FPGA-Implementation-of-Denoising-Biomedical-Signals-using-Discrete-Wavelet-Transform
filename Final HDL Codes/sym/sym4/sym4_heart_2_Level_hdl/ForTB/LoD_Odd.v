// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\LoD_Odd.v
...
// 
// Module: LoD_Odd
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Decomp/LoD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Odd
  ...
  assign Multiply4_cast = {1'b0, In_LoD_o_1};
  assign Multiply4_mul_temp = LoD_1_out1_1 * Multiply4_cast;
  assign Multiply4_cast_1 = Multiply4_mul_temp[31:0];
  assign Multiply4_out1 = {{12{Multiply4_cast_1[31]}}, Multiply4_cast_1[31:28]};
  ...
  assign Multiply_mul_temp = LoD_3_out1_1 * Rate_Transition_out1;
  ...
  assign Multiply1_mul_temp = LoD_5_out1_1 * Multiply1_cast;
  ...
  assign Multiply2_mul_temp = LoD_7_out1_1 * Rate_Transition2_out1;
  ...
  assign Add1_add_cast_1 = {2'b0, Multiply2_out1_1[15:2]};
