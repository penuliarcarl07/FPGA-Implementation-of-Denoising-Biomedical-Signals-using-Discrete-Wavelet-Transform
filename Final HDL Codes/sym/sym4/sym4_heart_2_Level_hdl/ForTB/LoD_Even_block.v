// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\LoD_Even_block.v
...
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Decomp1/LoD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Even_block
  ...
  assign Multiply4_mul_temp = LoD_0_out1_1 * In_LoD_e_1;
  assign Multiply4_out1 = {{10{Multiply4_mul_temp[31]}}, Multiply4_mul_temp[31:26]};
  ...
  assign Multiply_cast = {1'b0, LoD_2_out1_1};
  ...
  assign Multiply1_cast = {1'b0, LoD_4_out1_1};
  ...
  assign Multiply2_mul_temp = LoD_6_out1_1 * Rate_Transition2_out1;
  assign Multiply2_out1 = {{13{Multiply2_mul_temp[31]}}, Multiply2_mul_temp[31:29]};
