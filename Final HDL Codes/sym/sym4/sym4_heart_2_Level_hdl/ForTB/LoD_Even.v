// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\LoD_Even.v
// Created: 2024-04-18 18:03:51
// 
...
// 
// Module: LoD_Even
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Decomp/LoD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module LoD_Even
  ...
  input   reset;
  input   enb;
  input   [15:0] In_LoD_e;  // ufix16_En23
  output  signed [15:0] Out_LoD_e;  // sfix16_En23


  wire signed [15:0] LoD_0_out1;  // sfix16_En18
  reg signed [15:0] LoD_0_out1_1;  // sfix16_En18
  reg [15:0] In_LoD_e_1;  // ufix16_En23
  wire signed [16:0] Multiply4_cast;  // sfix17_En23
  ...
  wire [15:0] LoD_2_out1;  // ufix16_En17
  reg [15:0] LoD_2_out1_1;  // ufix16_En17
  ...
  wire [15:0] LoD_4_out1;  // ufix16_En17
  reg [15:0] LoD_4_out1_1;  // ufix16_En17
  ...
  wire signed [15:0] LoD_6_out1;  // sfix16_En21
  reg signed [15:0] LoD_6_out1_1;  // sfix16_En21
  ...
  assign LoD_0_out1 = 16'sb1011001001101010;
  ...
  assign Multiply4_cast = {1'b0, In_LoD_e_1};
  assign Multiply4_mul_temp = LoD_0_out1_1 * Multiply4_cast;
  assign Multiply4_cast_1 = Multiply4_mul_temp[31:0];
  assign Multiply4_out1 = {{10{Multiply4_cast_1[31]}}, Multiply4_cast_1[31:26]};
  ...
  assign LoD_2_out1 = 16'b1111111011001000;
  ...
  assign Multiply_mul_temp = LoD_2_out1_1 * Rate_Transition_out1;
  ...
  assign LoD_4_out1 = 16'b1001100010000001;
  ...
  assign Multiply1_mul_temp = LoD_4_out1_1 * Rate_Transition1_out1;
  ...
  assign LoD_6_out1 = 16'sb1001100011000000;
  ...
  assign Multiply2_cast = {1'b0, Rate_Transition2_out1};
  assign Multiply2_mul_temp = LoD_6_out1_1 * Multiply2_cast;
  assign Multiply2_cast_1 = Multiply2_mul_temp[31:0];
  assign Multiply2_out1 = {{13{Multiply2_cast_1[31]}}, Multiply2_cast_1[31:29]};
