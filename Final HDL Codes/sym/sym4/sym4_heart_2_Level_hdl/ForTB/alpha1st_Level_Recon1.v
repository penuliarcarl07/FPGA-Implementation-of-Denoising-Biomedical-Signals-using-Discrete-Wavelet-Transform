// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\alpha1st_Level_Recon1.v
...
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Recon1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon1
  ...
  wire signed [15:0] HiR_Even_out1;  // sfix16_En29
  wire signed [15:0] LoR_Even_out1;  // sfix16_En23
  reg signed [15:0] delayMatch_reg [0:6];  // sfix16 [7]
  wire signed [15:0] delayMatch_reg_next [0:6];  // sfix16_En23 [7]
  wire signed [15:0] LoR_Even_out1_1;  // sfix16_En23
  ...
  wire signed [15:0] delayMatch1_reg_next [0:6];  // sfix16_En23 [7]
  wire signed [15:0] LoR_Odd_out1_1;  // sfix16_En23
  ...
  assign kconst = 16'b1110110010100000;
  ...
  HiR_Even u_HiR_Even (.clk(clk),
                       ...
                       .Out_HiR_e(HiR_Even_out1)  // sfix16_En29
                       );
  ...
  assign Add3_add_cast = {{6{HiR_Even_out1[15]}}, HiR_Even_out1[15:6]};
