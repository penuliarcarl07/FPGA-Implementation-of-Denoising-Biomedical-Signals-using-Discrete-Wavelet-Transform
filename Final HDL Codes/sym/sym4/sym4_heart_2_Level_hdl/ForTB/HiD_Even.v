// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym4_2_Level_fixed\HiD_Even.v
...
// 
// Module: HiD_Even
// Source Path: final_heart_sym4_2_Level_fixed/DWT_sym4_2_Level/1st_Level_Decomp/HiD_Even
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Even
  ...
  wire [31:0] Multiply2_mul_temp;  // ufix32_En44
  ...
  assign Multiply4_cast = {1'b0, In_HiD_e_1};
  assign Multiply4_mul_temp = HiD_0_out1_1 * Multiply4_cast;
  assign Multiply4_cast_1 = Multiply4_mul_temp[31:0];
  assign Multiply4_out1 = {{11{Multiply4_cast_1[31]}}, Multiply4_cast_1[31:27]};
  ...
  assign Multiply_mul_temp = HiD_2_out1_1 * Rate_Transition_out1;
  ...
  assign Multiply1_cast = {1'b0, Rate_Transition1_out1};
  assign Multiply1_mul_temp = HiD_4_out1_1 * Multiply1_cast;
  assign Multiply1_cast_1 = Multiply1_mul_temp[31:0];
  assign Multiply1_out1 = {{7{Multiply1_cast_1[31]}}, Multiply1_cast_1[31:23]};
  ...
  assign Multiply2_mul_temp = HiD_6_out1_1 * Rate_Transition2_out1;
