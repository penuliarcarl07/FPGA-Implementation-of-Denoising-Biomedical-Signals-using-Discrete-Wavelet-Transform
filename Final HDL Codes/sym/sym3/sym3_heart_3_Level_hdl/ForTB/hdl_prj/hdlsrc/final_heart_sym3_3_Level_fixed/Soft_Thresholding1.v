// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_3_Level_fixed\Soft_Thresholding1.v
...
// Source Path: final_heart_sym3_3_Level_fixed/DWT_sym3_3_Level/Soft_Thresholding1
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Soft_Thresholding1
  ...
  wire [15:0] reduced_reg_next [0:54];  // ufix16_En26 [55]
  wire [15:0] Threshold1_2;  // ufix16_En26
  wire signed [37:0] Relational_Operator2_1_cast;  // sfix38_En27
  wire signed [37:0] Relational_Operator2_1_cast_1;  // sfix38_En27
  ...
  reg signed [15:0] Delay4_out1;  // sfix16_En25
  ...
  wire [37:0] Relational_Operator1_1_cast;  // ufix38_En28
  wire [37:0] Relational_Operator1_1_cast_1;  // ufix38_En28
  wire Relational_Operator1_relop1;
  reg  Delay5_out1;
  wire signed [37:0] Relational_Operator5_1_cast;  // sfix38_En27
  wire signed [37:0] Relational_Operator5_1_cast_1;  // sfix38_En27
  wire Relational_Operator5_relop1;
  reg  Delay6_out1;
  wire Relational_Operator6_relop1;
  wire switch_compare_1_1;
  wire signed [15:0] Constant_out1;  // sfix16_En4
  wire signed [37:0] Relational_Operator7_1_cast;  // sfix38_En27
  wire signed [37:0] Relational_Operator7_1_cast_1;  // sfix38_En27
...
@[tracestart]
  // '<S8>/Relational Operator2'
  assign Relational_Operator2_1_cast = {{22{Signal_w[15]}}, Signal_w};
  assign Relational_Operator2_1_cast_1 = {21'b0, {Threshold1_2, 1'b0}};
...
@[tracestart]
  ...
  assign Relational_Operator1_1_cast = {22'b0, Abs_out1};
  assign Relational_Operator1_1_cast_1 = {20'b0, {Threshold1_2, 2'b00}};
...
@[traceend]
@[tracestart]
  // '<S8>/Relational Operator5'
  assign Relational_Operator5_1_cast = {{22{Signal_w[15]}}, Signal_w};
  assign Relational_Operator5_1_cast_1 = {21'b0, {Threshold1_2, 1'b0}};
...
@[traceend]
@[tracestart]
  // '<S8>/Relational Operator7'
  assign Relational_Operator7_1_cast = {{22{Signal_w[15]}}, Signal_w};
  assign Relational_Operator7_1_cast_1 = {21'b0, {Threshold1_2, 1'b0}};
