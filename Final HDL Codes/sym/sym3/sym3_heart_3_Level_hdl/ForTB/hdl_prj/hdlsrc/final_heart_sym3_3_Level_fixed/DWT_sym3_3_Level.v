// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_3_Level_fixed\DWT_sym3_3_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_sym3_3_Level
// Source Path: final_heart_sym3_3_Level_fixed/DWT_sym3_3_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_sym3_3_Level
  ...
  wire [15:0] Threshold_Estimator_out1;  // ufix16_En26
  ...
  reg signed [15:0] Rate_Transition5_out1;  // sfix16_En24
  ...
  DWT_sym3_3_Level_tc u_DWT_sym3_3_Level_tc (.clk(clk),
                                             .reset(reset),
...
@[tracestart]
  ...
  alpha1st_Level_Decomp u_1st_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(Rate_Transition_out1),  // ufix16_En24
                                            .In_O(Rate_Transition1_out1),  // ufix16_En24
...
@[traceend]
@[tracestart]
  // '<S1>/Threshold_Estimator'
  Threshold_Estimator u_Threshold_Estimator (.clk(clk),
                                             .reset(reset),
                                             .enb(enb),
                                             .Signal_w(alpha1st_Level_Decomp1_out1),  // sfix16_En27
                                             .Threshold(Threshold_Estimator_out1)  // ufix16_En26
                                             );
@[traceend]
@[tracestart]
  // '<S1>/Soft_Thresholding3'
  Soft_Thresholding3 u_Soft_Thresholding3 (.clk(clk),
                                           .reset(reset),
                                           .enb(enb),
                                           .Signal_w(alpha1st_Level_Decomp_out1),  // sfix16_En25
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En26
                                           .New_Threshold(Soft_Thresholding3_out1)  // sfix16_En28
                                           );
@[traceend]
@[tracestart]
  // '<S1>/Soft_Thresholding2'
...
@[tracestart]
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .Out1(alpha1st_Level_Recon_out1)  // sfix16_En24
                                          );
@[traceend]
@[tracestart]
  // '<S1>/1st_Level_Recon1'
...
@[traceend]
  assign Out1 = alpha1st_Level_Recon2_out1;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_sym3_3_Level
