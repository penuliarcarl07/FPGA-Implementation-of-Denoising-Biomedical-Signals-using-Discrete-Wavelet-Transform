// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_4_Level_fixed\DWT_sym3_4_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_sym3_4_Level
// Source Path: final_heart_sym3_4_Level_fixed/DWT_sym3_4_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_sym3_4_Level
  ...
  wire signed [15:0] alpha1st_Level_Decomp1_out2;  // sfix16_En23
  ...
  reg signed [15:0] alpha1st_Level_Decomp1_out2_1;  // sfix16_En23
  reg signed [15:0] reduced_reg_1 [0:25];  // sfix16 [26]
  wire signed [15:0] reduced_reg_next_1 [0:25];  // sfix16_En23 [26]
  wire signed [15:0] alpha1st_Level_Decomp1_out2_2;  // sfix16_En23
  reg signed [15:0] Downsample5_out1;  // sfix16_En23
  reg signed [15:0] Downsample5_out1_1;  // sfix16_En23
  reg signed [15:0] Rate_Transition4_out1;  // sfix16_En23
  reg signed [15:0] Downsample6_ds_out;  // sfix16_En23
  reg signed [15:0] Downsample6_out1;  // sfix16_En23
  reg signed [15:0] Downsample6_out1_1;  // sfix16_En23
  reg signed [15:0] Rate_Transition5_out1;  // sfix16_En23
  wire signed [15:0] alpha1st_Level_Decomp2_out1;  // sfix16_En27
  wire signed [15:0] alpha1st_Level_Decomp2_out2;  // sfix16_En23
  wire signed [15:0] Soft_Thresholding2_out1;  // sfix16_En27
  reg signed [15:0] alpha1st_Level_Decomp2_out2_1;  // sfix16_En23
  reg signed [15:0] reduced_reg_2 [0:25];  // sfix16 [26]
  wire signed [15:0] reduced_reg_next_2 [0:25];  // sfix16_En23 [26]
  wire signed [15:0] alpha1st_Level_Decomp2_out2_2;  // sfix16_En23
  reg signed [15:0] Downsample7_out1;  // sfix16_En23
  reg signed [15:0] Downsample7_out1_1;  // sfix16_En23
  reg signed [15:0] Rate_Transition6_out1;  // sfix16_En23
  reg signed [15:0] Downsample8_ds_out;  // sfix16_En23
  reg signed [15:0] Downsample8_out1;  // sfix16_En23
  reg signed [15:0] Downsample8_out1_1;  // sfix16_En23
  reg signed [15:0] Rate_Transition7_out1;  // sfix16_En23
  wire signed [15:0] alpha1st_Level_Decomp3_out1;  // sfix16_En27
  wire signed [15:0] alpha1st_Level_Decomp3_out2;  // sfix16_En24
  ...
  wire signed [15:0] Denoised_Heart_Sound_Sym_3_Level_4;  // sfix16_En22


  DWT_sym3_4_Level_tc u_DWT_sym3_4_Level_tc (.clk(clk),
                                             .reset(reset),
  ...
  alpha1st_Level_Decomp1 u_1st_Level_Decomp1 (.clk(clk),
                                              ...
                                              .Out_LoD(alpha1st_Level_Decomp1_out2)  // sfix16_En23
                                              );
  ...
  always @(posedge clk)
    begin : Rate_Transition5_process
      if (reset == 1'b1) begin
        Rate_Transition5_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  alpha1st_Level_Decomp2 u_1st_Level_Decomp2 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .In_E(Rate_Transition4_out1),  // sfix16_En23
                                              .In_O(Rate_Transition5_out1),  // sfix16_En23
                                              .Out_HiD(alpha1st_Level_Decomp2_out1),  // sfix16_En27
                                              .Out_LoD(alpha1st_Level_Decomp2_out2)  // sfix16_En23
                                              );
  ...
  always @(posedge clk)
    begin : reduced_4_process
      if (reset == 1'b1) begin
        alpha1st_Level_Decomp2_out2_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : reduced_5_process
      if (reset == 1'b1) begin
        ...
        reduced_reg_2[2] <= 16'sb0000000000000000;
        reduced_reg_2[3] <= 16'sb0000000000000000;
        reduced_reg_2[4] <= 16'sb0000000000000000;
        reduced_reg_2[5] <= 16'sb0000000000000000;
        reduced_reg_2[6] <= 16'sb0000000000000000;
        reduced_reg_2[7] <= 16'sb0000000000000000;
        reduced_reg_2[8] <= 16'sb0000000000000000;
        reduced_reg_2[9] <= 16'sb0000000000000000;
        reduced_reg_2[10] <= 16'sb0000000000000000;
        reduced_reg_2[11] <= 16'sb0000000000000000;
        reduced_reg_2[12] <= 16'sb0000000000000000;
        reduced_reg_2[13] <= 16'sb0000000000000000;
        reduced_reg_2[14] <= 16'sb0000000000000000;
        reduced_reg_2[15] <= 16'sb0000000000000000;
        reduced_reg_2[16] <= 16'sb0000000000000000;
        reduced_reg_2[17] <= 16'sb0000000000000000;
        reduced_reg_2[18] <= 16'sb0000000000000000;
        reduced_reg_2[19] <= 16'sb0000000000000000;
        reduced_reg_2[20] <= 16'sb0000000000000000;
        reduced_reg_2[21] <= 16'sb0000000000000000;
        reduced_reg_2[22] <= 16'sb0000000000000000;
        reduced_reg_2[23] <= 16'sb0000000000000000;
        reduced_reg_2[24] <= 16'sb0000000000000000;
        reduced_reg_2[25] <= 16'sb0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : Downsample7_output_process
      if (reset == 1'b1) begin
        Downsample7_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_1) begin
  ...
  always @(posedge clk)
    begin : PipelineRegister4_process
      if (reset == 1'b1) begin
        Downsample7_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : Rate_Transition6_process
      if (reset == 1'b1) begin
        Rate_Transition6_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : Downsample8_ds_process
      if (reset == 1'b1) begin
        Downsample8_ds_out <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_4) begin
  ...
  always @(posedge clk)
    begin : Downsample8_output_process
      if (reset == 1'b1) begin
        Downsample8_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : PipelineRegister7_process
      if (reset == 1'b1) begin
        Downsample8_out1_1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : Rate_Transition7_process
      if (reset == 1'b1) begin
        Rate_Transition7_out1 <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  alpha1st_Level_Decomp3 u_1st_Level_Decomp3 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .In_E(Rate_Transition6_out1),  // sfix16_En23
                                              .In_O(Rate_Transition7_out1),  // sfix16_En23
                                              .Out_HiD(alpha1st_Level_Decomp3_out1),  // sfix16_En27
                                              .Out_LoD(alpha1st_Level_Decomp3_out2)  // sfix16_En24
                                              );
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha1st_Level_Decomp3_out2),  // sfix16_En24
                                          .Out1(alpha1st_Level_Recon_out1)  // sfix16_En23
                                          );
  alpha1st_Level_Recon1 u_1st_Level_Recon1 (.clk(clk),
                                            ...
                                            .Out1(alpha1st_Level_Recon1_out1)  // sfix16_En23
                                            );
  alpha1st_Level_Recon2 u_1st_Level_Recon2 (.clk(clk),
                                            ...
                                            .Out1(alpha1st_Level_Recon2_out1)  // sfix16_En23
                                            );
  alpha1st_Level_Recon3 u_1st_Level_Recon3 (.clk(clk),
                                            ...
                                            .Out1(Denoised_Heart_Sound_Sym_3_Level_4)  // sfix16_En22
                                            );
  assign Out1 = Denoised_Heart_Sound_Sym_3_Level_4;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_sym3_4_Level
