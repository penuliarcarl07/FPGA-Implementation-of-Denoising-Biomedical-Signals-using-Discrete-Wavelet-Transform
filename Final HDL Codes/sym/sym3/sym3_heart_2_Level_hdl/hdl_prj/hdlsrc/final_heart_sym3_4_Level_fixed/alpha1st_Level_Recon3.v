// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_4_Level_fixed\alpha1st_Level_Recon3.v
...
// Source Path: final_heart_sym3_4_Level_fixed/DWT_sym3_4_Level/1st_Level_Recon3
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Recon3
  ...
  reg signed [15:0] delayMatch_reg [0:122];  // sfix16 [123]
  wire signed [15:0] delayMatch_reg_next [0:122];  // sfix16_En28 [123]
  ...
  reg signed [15:0] delayMatch1_reg [0:122];  // sfix16 [123]
  wire signed [15:0] delayMatch1_reg_next [0:122];  // sfix16_En28 [123]
  ...
  wire signed [15:0] Add4_out1;  // sfix16_En23
  reg signed [15:0] Delay4_out1;  // sfix16_En23
  wire signed [15:0] Add5_add_cast;  // sfix16_En22
  wire signed [15:0] Add5_add_cast_1;  // sfix16_En22
  wire signed [15:0] Add5_out1;  // sfix16_En22
  reg signed [15:0] Add5_out1_1;  // sfix16_En22
  ...
  assign HiR_Even_out1_1 = delayMatch_reg[122];
  ...
  assign Add3_add_cast = {{5{HiR_Even_out1_1[15]}}, HiR_Even_out1_1[15:5]};
  ...
  assign HiR_Odd_out1_1 = delayMatch1_reg[122];
  ...
  assign Add4_add_cast = {{5{HiR_Odd_out1_1[15]}}, HiR_Odd_out1_1[15:5]};
