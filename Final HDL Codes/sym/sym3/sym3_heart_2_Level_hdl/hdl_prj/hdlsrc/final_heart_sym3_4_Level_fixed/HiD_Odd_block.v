// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_4_Level_fixed\HiD_Odd_block.v
...
// Source Path: final_heart_sym3_4_Level_fixed/DWT_sym3_4_Level/1st_Level_Decomp1/HiD_Odd
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module HiD_Odd_block
  ...
  wire [15:0] Multiply4_out1;  // ufix16_En28
  reg [15:0] delayMatch_reg [0:1];  // ufix16 [2]
  wire [15:0] delayMatch_reg_next [0:1];  // ufix16_En28 [2]
  wire [15:0] Multiply4_out1_1;  // ufix16_En28
  wire signed [15:0] Add3_add_cast;  // sfix16_En25
  wire signed [15:0] Add3_add_cast_1;  // sfix16_En25
  wire signed [15:0] Add3_add_temp;  // sfix16_En25
  ...
  assign Add3_add_cast = {Multiply3_out1_1[5:0], 10'b0000000000};
