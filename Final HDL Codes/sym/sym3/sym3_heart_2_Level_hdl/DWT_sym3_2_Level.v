// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym3_2_Level_hdl_final2\DWT_sym3_2_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_sym3_2_Level
// Source Path: final_heart_sym3_2_Level_hdl_final2/DWT_sym3_2_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_sym3_2_Level
  ...
  wire signed [15:0] Denoised_Heart_Sound_Sym_3_Level_2;  // sfix16_En23


  DWT_sym3_2_Level_tc u_DWT_sym3_2_Level_tc (.clk(clk),
                                             .reset(reset),
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha1st_Level_Decomp1_out2),  // sfix16_En24
  ...
  alpha1st_Level_Recon1 u_1st_Level_Recon1 (.clk(clk),
                                            ...
                                            .Out1(Denoised_Heart_Sound_Sym_3_Level_2)  // sfix16_En23
                                            );
  assign Out1 = Denoised_Heart_Sound_Sym_3_Level_2;

  assign ce_out = enb_1_1_1;

endmodule  // DWT_sym3_2_Level
