// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym2_level5_hdl\alpha1st_Level_Decomp4.v
...
// Source Path: final_heart_sym2_level5_hdl/DWT_Sym2_Level5/1st_Level_Decomp4
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module alpha1st_Level_Decomp4
  ...
  HiD_Even_block3 u_HiD_Even (.clk(clk),
                              .reset(reset),
                              .enb(enb),
                              .In_HiD_e(In_E),  // ufix16_En24
                              .Out_HiD_e(HiD_Even_out1)  // sfix16_En15
                              );
  HiD_Odd_block3 u_HiD_Odd (.clk(clk),
                            .reset(reset),
                            .enb(enb),
  ...
  LoD_Even_block3 u_LoD_Even (.clk(clk),
                              .reset(reset),
                              .enb(enb),
                              .In_LoD_e(In_E),  // ufix16_En24
                              .Out_LoD_e(LoD_Even_out1)  // sfix16_En24
                              );
  LoD_Odd_block3 u_LoD_Odd (.clk(clk),
                            .reset(reset),
                            .enb(enb),
