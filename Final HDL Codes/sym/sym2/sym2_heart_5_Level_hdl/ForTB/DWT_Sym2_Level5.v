// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym2_level5_hdl\DWT_Sym2_Level5.v
...
// -------------------------------------------------------------
// 
// Module: DWT_Sym2_Level5
// Source Path: final_heart_sym2_level5_hdl/DWT_Sym2_Level5
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_Sym2_Level5
  ...
  reg [15:0] Downsample4_out1;  // ufix16_En23
  reg [15:0] Downsample4_out1_1;  // ufix16_En23
  ...
  reg signed [15:0] alpha1st_Level_Decomp_out2_1;  // sfix16_En22
  reg signed [15:0] reduced_reg [0:25];  // sfix16 [26]
  wire signed [15:0] reduced_reg_next [0:25];  // sfix16_En22 [26]
  wire signed [15:0] alpha1st_Level_Decomp_out2_2;  // sfix16_En22
  ...
  reg signed [15:0] Downsample3_ds_out;  // sfix16_En22
  reg signed [15:0] Downsample3_out1;  // sfix16_En22
  reg signed [15:0] Downsample3_out1_1;  // sfix16_En22
  ...
  wire signed [15:0] Soft_Thresholding4_out1;  // sfix16_En27
  reg [15:0] alpha1st_Level_Decomp1_out2_1;  // ufix16_En24
  reg [15:0] reduced_reg_1 [0:25];  // ufix16 [26]
  wire [15:0] reduced_reg_next_1 [0:25];  // ufix16_En24 [26]
  wire [15:0] alpha1st_Level_Decomp1_out2_2;  // ufix16_En24
  reg [15:0] Downsample5_out1;  // ufix16_En24
  reg [15:0] Downsample5_out1_1;  // ufix16_En24
  reg [15:0] Rate_Transition5_out1;  // ufix16_En24
  reg [15:0] Downsample6_ds_out;  // ufix16_En24
  reg [15:0] Downsample6_out1;  // ufix16_En24
  reg [15:0] Downsample6_out1_1;  // ufix16_En24
  ...
  wire signed [15:0] Soft_Thresholding2_out1;  // sfix16_En27
  reg [15:0] alpha1st_Level_Decomp2_out2_1;  // ufix16_En24
  reg [15:0] reduced_reg_2 [0:25];  // ufix16 [26]
  wire [15:0] reduced_reg_next_2 [0:25];  // ufix16_En24 [26]
  wire [15:0] alpha1st_Level_Decomp2_out2_2;  // ufix16_En24
  reg [15:0] Downsample7_out1;  // ufix16_En24
  reg [15:0] Downsample7_out1_1;  // ufix16_En24
  reg [15:0] Rate_Transition7_out1;  // ufix16_En24
  reg [15:0] Downsample8_ds_out;  // ufix16_En24
  reg [15:0] Downsample8_out1;  // ufix16_En24
  reg [15:0] Downsample8_out1_1;  // ufix16_En24
  reg [15:0] Rate_Transition8_out1;  // ufix16_En24
  ...
  reg [15:0] alpha1st_Level_Decomp3_out2_1;  // ufix16_En24
  reg [15:0] reduced_reg_3 [0:25];  // ufix16 [26]
  wire [15:0] reduced_reg_next_3 [0:25];  // ufix16_En24 [26]
  wire [15:0] alpha1st_Level_Decomp3_out2_2;  // ufix16_En24
  reg [15:0] Downsample9_out1;  // ufix16_En24
  reg [15:0] Downsample9_out1_1;  // ufix16_En24
  reg [15:0] Rate_Transition9_out1;  // ufix16_En24
  reg [15:0] Downsample10_ds_out;  // ufix16_En24
  reg [15:0] Downsample10_out1;  // ufix16_En24
  reg [15:0] Downsample10_out1_1;  // ufix16_En24
  reg [15:0] Rate_Transition10_out1;  // ufix16_En24
  ...
  DWT_Sym2_Level5_tc u_DWT_Sym2_Level5_tc (.clk(clk),
                                           .reset(reset),
  ...
  always @(posedge clk)
    begin : Rate_Transition2_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition2_out1 <= Downsample2_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Downsample1_output_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_1) begin
          Downsample1_out1 <= alpha1st_Level_Decomp_out2_2;
        end
      end
    end
  ...
  // Downsample register
  always @(posedge clk)
    begin : Downsample3_ds_process
      if (reset == 1'b1) begin
        Downsample3_ds_out <= 16'sb0000000000000000;
      end
      else begin
        if (enb_1_30_4) begin
          Downsample3_ds_out <= alpha1st_Level_Decomp_out2_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Downsample3_output_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Downsample3_out1 <= Downsample3_ds_out;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition4_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition4_out1 <= Downsample3_out1_1;
        end
      end
    end
  ...
  Soft_Thresholding4 u_Soft_Thresholding4 (.clk(clk),
                                           ...
                                           .Signal_w(alpha1st_Level_Decomp1_out1),  // sfix16_En26
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En25
                                           .New_Threshold(Soft_Thresholding4_out1)  // sfix16_En27
                                           );
  always @(posedge clk)
    begin : reduced_2_process
      if (reset == 1'b1) begin
        alpha1st_Level_Decomp1_out2_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : reduced_3_process
      if (reset == 1'b1) begin
        reduced_reg_1[0] <= 16'b0000000000000000;
        reduced_reg_1[1] <= 16'b0000000000000000;
        reduced_reg_1[2] <= 16'b0000000000000000;
        reduced_reg_1[3] <= 16'b0000000000000000;
        reduced_reg_1[4] <= 16'b0000000000000000;
        reduced_reg_1[5] <= 16'b0000000000000000;
        reduced_reg_1[6] <= 16'b0000000000000000;
        reduced_reg_1[7] <= 16'b0000000000000000;
        reduced_reg_1[8] <= 16'b0000000000000000;
        reduced_reg_1[9] <= 16'b0000000000000000;
        reduced_reg_1[10] <= 16'b0000000000000000;
        reduced_reg_1[11] <= 16'b0000000000000000;
        reduced_reg_1[12] <= 16'b0000000000000000;
        reduced_reg_1[13] <= 16'b0000000000000000;
        reduced_reg_1[14] <= 16'b0000000000000000;
        reduced_reg_1[15] <= 16'b0000000000000000;
        reduced_reg_1[16] <= 16'b0000000000000000;
        reduced_reg_1[17] <= 16'b0000000000000000;
        reduced_reg_1[18] <= 16'b0000000000000000;
        reduced_reg_1[19] <= 16'b0000000000000000;
        reduced_reg_1[20] <= 16'b0000000000000000;
        reduced_reg_1[21] <= 16'b0000000000000000;
        reduced_reg_1[22] <= 16'b0000000000000000;
        reduced_reg_1[23] <= 16'b0000000000000000;
        reduced_reg_1[24] <= 16'b0000000000000000;
        reduced_reg_1[25] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  always @(posedge clk)
    begin : Downsample5_output_process
      if (reset == 1'b1) begin
        Downsample5_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_1) begin
  ...
  always @(posedge clk)
    begin : PipelineRegister3_process
      if (reset == 1'b1) begin
        Downsample5_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : Rate_Transition5_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition5_out1 <= Downsample5_out1_1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Downsample6_ds_process
      if (reset == 1'b1) begin
        Downsample6_ds_out <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_4) begin
  ...
  always @(posedge clk)
    begin : Downsample6_output_process
      if (reset == 1'b1) begin
        Downsample6_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : PipelineRegister8_process
      if (reset == 1'b1) begin
        Downsample6_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
  ...
  always @(posedge clk)
    begin : Rate_Transition6_process
      if (reset == 1'b1) begin
        ...
        if (enb_1_30_0) begin
          Rate_Transition6_out1 <= Downsample6_out1_1;
        end
      end
    end
  ...
  Soft_Thresholding2 u_Soft_Thresholding2 (.clk(clk),
                                           ...
                                           .Threshold1(Threshold_Estimator_out1),  // ufix16_En25
                                           .New_Threshold(Soft_Thresholding2_out1)  // sfix16_En27
                                           );
  always @(posedge clk)
    begin : reduced_4_process
      if (reset == 1'b1) begin
        alpha1st_Level_Decomp2_out2_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          alpha1st_Level_Decomp2_out2_1 <= alpha1st_Level_Decomp2_out2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : reduced_5_process
      if (reset == 1'b1) begin
        reduced_reg_2[0] <= 16'b0000000000000000;
        reduced_reg_2[1] <= 16'b0000000000000000;
        reduced_reg_2[2] <= 16'b0000000000000000;
        reduced_reg_2[3] <= 16'b0000000000000000;
        reduced_reg_2[4] <= 16'b0000000000000000;
        reduced_reg_2[5] <= 16'b0000000000000000;
        reduced_reg_2[6] <= 16'b0000000000000000;
        reduced_reg_2[7] <= 16'b0000000000000000;
        reduced_reg_2[8] <= 16'b0000000000000000;
        reduced_reg_2[9] <= 16'b0000000000000000;
        reduced_reg_2[10] <= 16'b0000000000000000;
        reduced_reg_2[11] <= 16'b0000000000000000;
        reduced_reg_2[12] <= 16'b0000000000000000;
        reduced_reg_2[13] <= 16'b0000000000000000;
        reduced_reg_2[14] <= 16'b0000000000000000;
        reduced_reg_2[15] <= 16'b0000000000000000;
        reduced_reg_2[16] <= 16'b0000000000000000;
        reduced_reg_2[17] <= 16'b0000000000000000;
        reduced_reg_2[18] <= 16'b0000000000000000;
        reduced_reg_2[19] <= 16'b0000000000000000;
        reduced_reg_2[20] <= 16'b0000000000000000;
        reduced_reg_2[21] <= 16'b0000000000000000;
        reduced_reg_2[22] <= 16'b0000000000000000;
        reduced_reg_2[23] <= 16'b0000000000000000;
        reduced_reg_2[24] <= 16'b0000000000000000;
        reduced_reg_2[25] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign alpha1st_Level_Decomp2_out2_2 = reduced_reg_2[25];
  assign reduced_reg_next_2[0] = alpha1st_Level_Decomp2_out2_1;
  ...
  assign reduced_reg_next_2[10] = reduced_reg_2[9];
  assign reduced_reg_next_2[11] = reduced_reg_2[10];
  assign reduced_reg_next_2[12] = reduced_reg_2[11];
  assign reduced_reg_next_2[13] = reduced_reg_2[12];
  assign reduced_reg_next_2[14] = reduced_reg_2[13];
  assign reduced_reg_next_2[15] = reduced_reg_2[14];
  assign reduced_reg_next_2[16] = reduced_reg_2[15];
  assign reduced_reg_next_2[17] = reduced_reg_2[16];
  assign reduced_reg_next_2[18] = reduced_reg_2[17];
  assign reduced_reg_next_2[19] = reduced_reg_2[18];
  assign reduced_reg_next_2[20] = reduced_reg_2[19];
  assign reduced_reg_next_2[21] = reduced_reg_2[20];
  assign reduced_reg_next_2[22] = reduced_reg_2[21];
  assign reduced_reg_next_2[23] = reduced_reg_2[22];
  assign reduced_reg_next_2[24] = reduced_reg_2[23];
  assign reduced_reg_next_2[25] = reduced_reg_2[24];



  // Downsample by 30 register (Sample offset 0)
  always @(posedge clk)
    begin : Downsample7_output_process
      if (reset == 1'b1) begin
        Downsample7_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_1) begin
          Downsample7_out1 <= alpha1st_Level_Decomp2_out2_2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : PipelineRegister4_process
      if (reset == 1'b1) begin
        Downsample7_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample7_out1_1 <= Downsample7_out1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition7_process
      if (reset == 1'b1) begin
        Rate_Transition7_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Rate_Transition7_out1 <= Downsample7_out1_1;
        end
      end
    end
  ...
  // Downsample register
  always @(posedge clk)
    begin : Downsample8_ds_process
      if (reset == 1'b1) begin
        Downsample8_ds_out <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_4) begin
          Downsample8_ds_out <= alpha1st_Level_Decomp2_out2_1;
        end
      end
    end
  ...
  // Downsample output register
  always @(posedge clk)
    begin : Downsample8_output_process
      if (reset == 1'b1) begin
        Downsample8_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample8_out1 <= Downsample8_ds_out;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : PipelineRegister9_process
      if (reset == 1'b1) begin
        Downsample8_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample8_out1_1 <= Downsample8_out1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition8_process
      if (reset == 1'b1) begin
        Rate_Transition8_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Rate_Transition8_out1 <= Downsample8_out1_1;
        end
      end
    end
  ...
  alpha1st_Level_Decomp3 u_1st_Level_Decomp3 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .In_E(Rate_Transition7_out1),  // ufix16_En24
                                              .In_O(Rate_Transition8_out1),  // ufix16_En24
  ...
  always @(posedge clk)
    begin : reduced_6_process
      if (reset == 1'b1) begin
        alpha1st_Level_Decomp3_out2_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
          alpha1st_Level_Decomp3_out2_1 <= alpha1st_Level_Decomp3_out2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : reduced_7_process
      if (reset == 1'b1) begin
        reduced_reg_3[0] <= 16'b0000000000000000;
        reduced_reg_3[1] <= 16'b0000000000000000;
        reduced_reg_3[2] <= 16'b0000000000000000;
        reduced_reg_3[3] <= 16'b0000000000000000;
        reduced_reg_3[4] <= 16'b0000000000000000;
        reduced_reg_3[5] <= 16'b0000000000000000;
        reduced_reg_3[6] <= 16'b0000000000000000;
        reduced_reg_3[7] <= 16'b0000000000000000;
        reduced_reg_3[8] <= 16'b0000000000000000;
        reduced_reg_3[9] <= 16'b0000000000000000;
        reduced_reg_3[10] <= 16'b0000000000000000;
        reduced_reg_3[11] <= 16'b0000000000000000;
        reduced_reg_3[12] <= 16'b0000000000000000;
        reduced_reg_3[13] <= 16'b0000000000000000;
        reduced_reg_3[14] <= 16'b0000000000000000;
        reduced_reg_3[15] <= 16'b0000000000000000;
        reduced_reg_3[16] <= 16'b0000000000000000;
        reduced_reg_3[17] <= 16'b0000000000000000;
        reduced_reg_3[18] <= 16'b0000000000000000;
        reduced_reg_3[19] <= 16'b0000000000000000;
        reduced_reg_3[20] <= 16'b0000000000000000;
        reduced_reg_3[21] <= 16'b0000000000000000;
        reduced_reg_3[22] <= 16'b0000000000000000;
        reduced_reg_3[23] <= 16'b0000000000000000;
        reduced_reg_3[24] <= 16'b0000000000000000;
        reduced_reg_3[25] <= 16'b0000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign alpha1st_Level_Decomp3_out2_2 = reduced_reg_3[25];
  assign reduced_reg_next_3[0] = alpha1st_Level_Decomp3_out2_1;
  ...
  assign reduced_reg_next_3[10] = reduced_reg_3[9];
  assign reduced_reg_next_3[11] = reduced_reg_3[10];
  assign reduced_reg_next_3[12] = reduced_reg_3[11];
  assign reduced_reg_next_3[13] = reduced_reg_3[12];
  assign reduced_reg_next_3[14] = reduced_reg_3[13];
  assign reduced_reg_next_3[15] = reduced_reg_3[14];
  assign reduced_reg_next_3[16] = reduced_reg_3[15];
  assign reduced_reg_next_3[17] = reduced_reg_3[16];
  assign reduced_reg_next_3[18] = reduced_reg_3[17];
  assign reduced_reg_next_3[19] = reduced_reg_3[18];
  assign reduced_reg_next_3[20] = reduced_reg_3[19];
  assign reduced_reg_next_3[21] = reduced_reg_3[20];
  assign reduced_reg_next_3[22] = reduced_reg_3[21];
  assign reduced_reg_next_3[23] = reduced_reg_3[22];
  assign reduced_reg_next_3[24] = reduced_reg_3[23];
  assign reduced_reg_next_3[25] = reduced_reg_3[24];



  // Downsample by 30 register (Sample offset 0)
  always @(posedge clk)
    begin : Downsample9_output_process
      if (reset == 1'b1) begin
        Downsample9_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_1) begin
          Downsample9_out1 <= alpha1st_Level_Decomp3_out2_2;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : PipelineRegister5_process
      if (reset == 1'b1) begin
        Downsample9_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample9_out1_1 <= Downsample9_out1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition9_process
      if (reset == 1'b1) begin
        Rate_Transition9_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Rate_Transition9_out1 <= Downsample9_out1_1;
        end
      end
    end
  ...
  // Downsample register
  always @(posedge clk)
    begin : Downsample10_ds_process
      if (reset == 1'b1) begin
        Downsample10_ds_out <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_4) begin
          Downsample10_ds_out <= alpha1st_Level_Decomp3_out2_1;
        end
      end
    end
  ...
  // Downsample output register
  always @(posedge clk)
    begin : Downsample10_output_process
      if (reset == 1'b1) begin
        Downsample10_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample10_out1 <= Downsample10_ds_out;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : PipelineRegister6_process
      if (reset == 1'b1) begin
        Downsample10_out1_1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Downsample10_out1_1 <= Downsample10_out1;
        end
      end
    end
  ...
  always @(posedge clk)
    begin : Rate_Transition10_process
      if (reset == 1'b1) begin
        Rate_Transition10_out1 <= 16'b0000000000000000;
      end
      else begin
        if (enb_1_30_0) begin
          Rate_Transition10_out1 <= Downsample10_out1_1;
        end
      end
    end
  ...
  alpha1st_Level_Decomp4 u_1st_Level_Decomp4 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .In_E(Rate_Transition9_out1),  // ufix16_En24
                                              .In_O(Rate_Transition10_out1),  // ufix16_En24
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha1st_Level_Decomp4_out2),  // ufix16_En24
  ...
  alpha1st_Level_Recon2 u_1st_Level_Recon2 (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_HiD(Soft_Thresholding2_out1),  // sfix16_En27
  ...
  alpha1st_Level_Recon3 u_1st_Level_Recon3 (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_HiD(Soft_Thresholding4_out1),  // sfix16_En27
