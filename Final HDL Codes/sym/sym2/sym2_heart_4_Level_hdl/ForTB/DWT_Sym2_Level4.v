// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym2_level4_hdl\DWT_Sym2_Level4.v
...
// -------------------------------------------------------------
// 
// Module: DWT_Sym2_Level4
// Source Path: final_heart_sym2_level4_hdl/DWT_Sym2_Level4
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_Sym2_Level4
          (clk,
           ...
           In1,
           ce_out,
           Denoised_Heart_Sound_Sym_2_Level_4);
  ...
  output  ce_out;
  output  signed [15:0] Denoised_Heart_Sound_Sym_2_Level_4;  // sfix16_En22
  ...
  wire signed [15:0] alpha1st_Level_Recon2_out1;  // sfix16_En22


  DWT_Sym2_Level4_tc u_DWT_Sym2_Level4_tc (.clk(clk),
                                           .reset(reset),
  ...
  alpha1st_Level_Recon u_1st_Level_Recon (.clk(clk),
                                          ...
                                          .In_LoD(alpha1st_Level_Decomp3_out2),  // ufix16_En24
  ...
  alpha1st_Level_Recon2 u_1st_Level_Recon2 (.clk(clk),
                                            ...
                                            .Out(alpha1st_Level_Recon2_out1)  // sfix16_En22
                                            );
  alpha1st_Level_Recon3 u_1st_Level_Recon3 (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_HiD(Soft_Thresholding4_out1),  // sfix16_En28
                                            .In_LoD(alpha1st_Level_Recon2_out1),  // sfix16_En22
                                            .Out(Denoised_Heart_Sound_Sym_2_Level_4)  // sfix16_En22
                                            );
  assign ce_out = enb_1_1_1;

endmodule  // DWT_Sym2_Level4
