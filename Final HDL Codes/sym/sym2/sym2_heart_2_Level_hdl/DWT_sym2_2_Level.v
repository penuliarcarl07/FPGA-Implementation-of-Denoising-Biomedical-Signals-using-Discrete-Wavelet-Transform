// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\final_heart_sym2_level2_fixed_hdl\DWT_sym2_2_Level.v
...
// -------------------------------------------------------------
// 
// Module: DWT_sym2_2_Level
// Source Path: final_heart_sym2_level2_fixed_hdl/DWT_sym2_2_Level
// Hierarchy Level: 0
// 
// -------------------------------------------------------------
...
module DWT_sym2_2_Level
  ...
  reg signed [15:0] Downsample1_out1;  // sfix16_En23
  reg signed [15:0] Downsample1_out1_1;  // sfix16_En23
  reg signed [15:0] Rate_Transition1_out1;  // sfix16_En23
  reg signed [15:0] Downsample3_ds_out;  // sfix16_En23
  ...
  DWT_sym2_2_Level_tc u_DWT_sym2_2_Level_tc (.clk(clk),
                                             .reset(reset),
  ...
  alpha1st_Level_Decomp u_1st_Level_Decomp (.clk(clk),
                                            .reset(reset),
                                            .enb(enb),
                                            .In_E(Rate_Transition2_out1),  // ufix16_En24
                                            .In_O(Rate_Transition3_out1),  // ufix16_En24
  ...
  alpha1st_Level_Decomp1 u_1st_Level_Decomp1 (.clk(clk),
                                              .reset(reset),
                                              .enb(enb),
                                              .In_E(Rate_Transition1_out1),  // sfix16_En23
                                              .In_O(Rate_Transition4_out1),  // sfix16_En23
